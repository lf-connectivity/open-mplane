...
YangParamSysrepo::YangParamSysrepo(sysrepo::S_Val value) : YangParam() {
  setSysrepo(value);
}

YangParamSysrepo::YangParamSysrepo(bool param) : YangParam(param) {}

YangParamSysrepo::YangParamSysrepo(int8_t param) : YangParam(param) {}

YangParamSysrepo::YangParamSysrepo(int16_t param) : YangParam(param) {}

YangParamSysrepo::YangParamSysrepo(int32_t param) : YangParam(param) {}

YangParamSysrepo::YangParamSysrepo(int64_t param) : YangParam(param) {}

YangParamSysrepo::YangParamSysrepo(uint8_t param) : YangParam(param) {}

YangParamSysrepo::YangParamSysrepo(uint16_t param) : YangParam(param) {}

YangParamSysrepo::YangParamSysrepo(uint32_t param) : YangParam(param) {}

YangParamSysrepo::YangParamSysrepo(uint64_t param) : YangParam(param) {}

YangParamSysrepo::YangParamSysrepo(std::string param) : YangParam(param) {}

sysrepo::S_Val
YangParamSysrepo::getSysrepo(void) const {
...
//=============================================================================================================
void
YangParamSysrepo::setSysrepo(sysrepo::S_Val value) {
  setName(value->xpath());
  switch (value->type()) {
    /* types containing some data */
    case SR_BOOL_T: /**< A boolean value ([RFC 7950
                       sec 9.5](http://tools.ietf.org/html/rfc7950#section-9.5))
                     */
      setBool(value->data()->get_bool());
      break;

    case SR_INT8_T: /**< 8-bit signed integer ([RFC 7950
                       sec 9.2](https://tools.ietf.org/html/rfc7950#section-9.2))
                     */
      setInt8(value->data()->get_int8());
      break;

    case SR_INT16_T: /**< 16-bit signed integer ([RFC 7950
                        sec 9.2](https://tools.ietf.org/html/rfc7950#section-9.2))
                      */
      setInt16(value->data()->get_int16());
      break;

    case SR_INT32_T: /**< 32-bit signed integer ([RFC 7950
                        sec 9.2](https://tools.ietf.org/html/rfc7950#section-9.2))
                      */
      setInt32(value->data()->get_int32());
      break;

    case SR_INT64_T: /**< 64-bit signed integer ([RFC 7950
                        sec 9.2](https://tools.ietf.org/html/rfc7950#section-9.2))
                      */
      setInt64(value->data()->get_int64());
      break;

    case SR_UINT8_T: /**< 8-bit unsigned integer ([RFC 7950
                        sec 9.2](https://tools.ietf.org/html/rfc7950#section-9.2))
                      */
      setUInt8(value->data()->get_uint8());
      break;

    case SR_UINT16_T: /**< 16-bit unsigned integer ([RFC 7950
                         sec 9.2](https://tools.ietf.org/html/rfc7950#section-9.2))
                       */
      setUInt16(value->data()->get_uint16());
      break;

    case SR_UINT32_T: /**< 32-bit unsigned integer ([RFC 7950
                         sec 9.2](https://tools.ietf.org/html/rfc7950#section-9.2))
                       */
      setUInt32(value->data()->get_uint32());
      break;

    case SR_UINT64_T: /**< 64-bit unsigned integer ([RFC 7950
                         sec 9.2](https://tools.ietf.org/html/rfc7950#section-9.2))
                       */
      setUInt64(value->data()->get_uint64());
      break;

    case SR_STRING_T: /**< Human-readable string ([RFC 7950
                         sec 9.4](http://tools.ietf.org/html/rfc7950#section-9.4))
                       */
      setString(std::string(value->data()->get_string()));
      break;

    case SR_DECIMAL64_T: /**< 64-bit signed decimal number ([RFC 7950
                            sec 9.3](http://tools.ietf.org/html/rfc7950#section-9.3))
                          */
    ...
    case SR_LIST_T: /**< List instance. ([RFC 7950
                       sec 7.8](http://tools.ietf.org/html/rfc7950#section-7.8))
                     */
    case SR_CONTAINER_T: /**< Non-presence container. ([RFC 7950
                            sec 7.5](http://tools.ietf.org/html/rfc7950#section-7.5))
                          */
    case SR_CONTAINER_PRESENCE_T: /**< Presence container. ([RFC 7950
                                     sec 7.5.1](http://tools.ietf.org/html/rfc7950#section-7.5.1))
                                   */
    case SR_LEAF_EMPTY_T: /**< A leaf that does not hold any value ([RFC 7950
                             sec 9.11](http://tools.ietf.org/html/rfc7950#section-9.11))
                           */
    case SR_NOTIFICATION_T: /**< Notification instance ([RFC 7095
                               sec 7.16](https://tools.ietf.org/html/rfc7950#section-7.16))
                             */
    case SR_ANYXML_T: /**< Unknown chunk of XML ([RFC 7950
                         sec 7.10](https://tools.ietf.org/html/rfc7950#section-7.10))
                       */
    case SR_ANYDATA_T: /**< Unknown set of nodes, encoded in XML ([RFC 7950
                          sec 7.10](https://tools.ietf.org/html/rfc7950#section-7.10))
                        */
    default:
      break;
