...
// ------------------------------------------------------------------------------------------------------------
std::shared_ptr<IRadioDataStore>
Mplane::YangModuleMgr::dataStore() const {
  return mRadioDs;
}

// ------------------------------------------------------------------------------------------------------------
YangModuleMgr::Status_E
YangModuleMgr::getStatus(void) const {
  return mStatus;
}

// ------------------------------------------------------------------------------------------------------------
void
YangModuleMgr::setStatus(YangModuleMgr::Status_E status) {
  mStatus = status;
}

// ------------------------------------------------------------------------------------------------------------
bool
YangModuleMgr::isInitialised(void) const {
  return (mStatus == Status_E::INITIALISED);
}

//-------------------------------------------------------------------------------------------------------------
YangResult_E
YangModuleMgr::initialise() {
  ...
  // Locate and install each configured module, enabling features and loading
  // startup data
  ...
  // Activate the radio datastore
    ...
    if ((result =
             ((startState == ReturnType::RT_OK) ? YangResult_E::OK
                                                : YangResult_E::FAIL)) !=
        YangResult_E::OK) {
  ...
  if (result == YangResult_E::OK) {
    setStatus(Status_E::INITIALISED);
  } else {
    setStatus(Status_E::FAILED);
  }
...
YangModuleMgr::getSupportedModuleList(void) {
  return mRadioDs->getListOfInstalledModules();
}

// ------------------------------------------------------------------------------------------------------------
void
YangModuleMgr::setSearchPath(const std::string& path) {
  mSearchPath = path;
}
...
// ------------------------------------------------------------------------------------------------------------
bool
YangModuleMgr::isFeatureEnabled(
    const std::string& moduleName, const std::string& feature) {
  bool enabled = false;
...
// ------------------------------------------------------------------------------------------------------------
bool
YangModuleMgr::isFeatureEnabled(uint32_t moduleId, const std::string& feature) {
  bool enabled = false;
...
// ------------------------------------------------------------------------------------------------------------
bool
YangModuleMgr::registerCallback(
    uint32_t moduleId, const std::string& xpath, YangHandlerCallback callback) {
  bool success = false;
 ...
 */
void
YangModuleMgr::processEvents(void) {
...
YangModuleMgr::getModule(const std::string& name) {
...
// ------------------------------------------------------------------------------------------------------------
std::shared_ptr<IYangModule>
YangModuleMgr::getModule(uint32_t id) {
...
// ------------------------------------------------------------------------------------------------------------
uint32_t
YangModuleMgr::getNumModules(void) const {
  return mModIds.size();
}

//-------------------------------------------------------------------------------------------------------------
void
YangModuleMgr::addModule(std::shared_ptr<IYangModule> module) {
  if (!module)
    return;

  // eventError("YangModuleMgr::addModule(" << module->getId() << ") " <<
  // module->getName() << ", " << module->getFilename());
...
//-------------------------------------------------------------------------------------------------------------
YangResult_E
YangModuleMgr::installModules(void) {
...
//-------------------------------------------------------------------------------------------------------------
YangResult_E
YangModuleMgr::installModules(const std::vector<std::string>& modules) {
  YangResult_E result(YangResult_E::FAIL);
  ...
  for (auto name : modules) {
    ...
    // An empty feature list is passed to installModule() as it fails to enable
    // features. Features enabled after install.
    std::vector<std::string> features;

    // Install module
    if (mRadioDs->installModule(name, mSearchPath, filename, features) !=
        YangResult_E::OK) {
...
YangModuleMgr::getModuleNamesAvailable(void) {
...
//#define ORAN_MODULE_LIST_PHASE1
//"ietf-interfaces,iana-hardware,ietf-hardware,ietf-netconf-acm,ietf-crypto-types,ietf-dhcpv6-types,ietf-inet-types,ietf-ip,iana-if-type,o-ran-interfaces,
// o-ran-operations,
// o-ran-processing-element,o-ran-compression-factors,o-ran-module-cap,
// o-ran-delay-management,          o-ran-laa-operations,
// o-ran-uplane-conf,o-ran-ald-port,o-ran-ald,
// o-ran-trace,o-ran-transceiver,o-ran-mplane-int,o-ran-dhcp, o-ran-sync,"
//#define ORAN_MODULE_LIST_PHASE2
//"ietf-interfaces,iana-hardware,ietf-hardware,ietf-netconf-acm,ietf-crypto-types,ietf-dhcpv6-types,ietf-inet-types,ietf-ip,iana-if-type,o-ran-interfaces,
// o-ran-hardware,                   o-ran-operations,
// o-ran-processing-element,o-ran-compression-factors,o-ran-module-cap,
// o-ran-delay-management,          o-ran-laa-operations,o-ran-lbm,
// o-ran-uplane-conf,o-ran-ald-port,o-ran-ald,
// o-ran-trace,o-ran-transceiver,o-ran-mplane-int,o-ran-dhcp, o-ran-sync,"
//#define ORAN_MODULE_LIST_PHASE3
//"ietf-interfaces,iana-hardware,ietf-hardware,ietf-netconf-acm,ietf-crypto-types,ietf-dhcpv6-types,ietf-inet-types,ietf-ip,iana-if-type,o-ran-interfaces,o-ran-supervision,o-ran-usermgmt,o-ran-hardware,
// o-ran-fm,o-ran-operations,o-ran-file-management,o-ran-software-management,o-ran-processing-element,o-ran-compression-factors,o-ran-module-cap,
// o-ran-delay-management,          o-ran-laa-operations,o-ran-lbm,
// o-ran-performance-management,o-ran-uplane-conf,o-ran-ald-port,o-ran-ald,o-ran-troubleshooting,o-ran-trace,o-ran-transceiver,o-ran-mplane-int,o-ran-dhcp,
// o-ran-sync," #define ORAN_MODULE_LIST_FULL
//"ietf-interfaces,iana-hardware,ietf-hardware,ietf-netconf-acm,ietf-crypto-types,ietf-dhcpv6-types,ietf-inet-types,ietf-ip,iana-if-type,o-ran-interfaces,o-ran-supervision,o-ran-usermgmt,o-ran-hardware,o-ran-fan,o-ran-fm,o-ran-operations,o-ran-file-management,o-ran-software-management,o-ran-processing-element,o-ran-compression-factors,o-ran-module-cap,o-ran-antenna-calibration,o-ran-delay-management,o-ran-laa,o-ran-laa-operations,o-ran-lbm,o-ran-udp-echo,o-ran-ecpri-delay,o-ran-performance-management,o-ran-uplane-conf,o-ran-ald-port,o-ran-ald,o-ran-troubleshooting,o-ran-trace,o-ran-transceiver,o-ran-mplane-int,o-ran-dhcp,o-ran-externalio,o-ran-sync,"

std::vector<std::string>
YangModuleMgr::getModuleNamesConfigured(void) {
...
std::string
YangModuleMgr::getPath(
    const std::string& moduleName, const std::string& xpath) {
...
//-------------------------------------------------------------------------------------------------------------
YangResult_E
YangModuleMgr::enableFeatures(const std::string& name) {
  ...
  for (auto& feature : featureList) {
    if (feature.second == true) {
      if (mRadioDs->enableFeature(name, feature.first) != YangResult_E::OK) {
        eventError(
            "Failed to enable %s module feature: %s",
            name.c_str(),
            feature.first.c_str());
