...
public:
 ...
 virtual Status_E getStatus(void) const override;
 virtual void setStatus(Status_E status) override;
  ...
  */
 virtual std::shared_ptr<IYangModule> getModule(
 ...
 virtual YangResult_E getItem(
     ...
     std::shared_ptr<YangParam>& param) override;
 virtual YangResult_E getItem(
     uint32_t moduleId,
     const std::string& xpath,
     std::shared_ptr<YangParam>& param) override;
 ...
 virtual YangResult_E getItems(
     const std::string& moduleName,
     const std::string& xpath,
     std::shared_ptr<YangParams>& params) override;
 virtual YangResult_E getItems(
     uint32_t moduleId,
     const std::string& xpath,
     std::shared_ptr<YangParams>& params) override;
 ...
 virtual bool isFeatureEnabled(
     const std::string& moduleName, const std::string& feature) override;
 virtual bool isFeatureEnabled(
     uint32_t moduleId, const std::string& feature) override;
 ...
 virtual bool registerCallback(
     uint32_t moduleId,
     const std::string& xpath,
     YangHandlerCallback callback) override;
 ...
 virtual bool testCallback(
     uint32_t moduleId,
     const std::string& xpath,
     std::shared_ptr<DataVariant> value) override;
