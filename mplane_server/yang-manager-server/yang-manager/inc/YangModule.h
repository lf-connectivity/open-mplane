...
protected:
 ...
 // make: REFERENCE
 virtual std::shared_ptr<YangReference> makeReference(
     YangReference& reference) const;

 // make: CONTAINER
 virtual std::shared_ptr<YangContainer> makeContainer(
     YangContainer& container) const;
...
public:
 ...
 // module, parameter
 YangPath(const std::string& module, const std::string& parameter);
 ...
 // module, parameter
 void add(const std::string& module, const std::string& parameter);
...
private:
 std::string path(
     bool preSlash = false, bool postSlash = true, bool postDot = false);
...
public:
  ...
  */
 virtual bool setFeature(
     const std::string& feature, bool enabled = true) override;
 ...
 virtual bool registerCallback(
     const std::string& xpath, YangHandlerCallback callback) override;

 /**
  * Get callback function for specified path
  */
 // virtual bool getCallback(const std::string & xpath, YangHandlerCallback &
 // callback) override;

 /**
  * Debug
  */
 virtual bool testCallback(
     const std::string& xpath, std::shared_ptr<DataVariant> value) override;

protected:

private:
 std::vector<std::shared_ptr<YangItem>> nextItem(
     std::shared_ptr<YangItem> item);
