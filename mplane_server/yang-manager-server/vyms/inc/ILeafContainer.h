...
public:
 ...
 virtual std::shared_ptr<ILeafContainer> getNamed(
     const std::string& name, bool recursive = true) const = 0;
 ...
 virtual void addLeaf(
     const std::string& leafName, const std::string& leafValue) = 0;
 ...
 virtual void addLeafUInt64(
     const std::string& leafName, uint64_t leafValue) = 0;

 /**
  * Add a leaf value to this container's contents
  */
 virtual void addLeafUInt32(
     const std::string& leafName, uint32_t leafValue) = 0;

 /**
  * Add a leaf value to this container's contents
  */
 virtual void addLeafUInt16(
     const std::string& leafName, uint16_t leafValue) = 0;
 ...
 /**
  * Add a leaf value to this container's contents. The value is fetched from
  * a given IYangConfig object at a path constructed from the baseConfigPath
  * and the leafName.
  */
 virtual void addLeafFromConfig(
     const std::string& leafName,
     std::shared_ptr<IYangConfig> config,
     const std::string& baseConfigPath) = 0;
 ...
 /**
  * Add a leaf-list value to this container's contents. The value is fetched
 ...
 /**
  * Add multiple leaf-list value to this container's contents. The values are
  * fetched from a given IYangConfig object. The path for each value is
  * constructed from the same baseConfigPath and each leaf name.
  */
