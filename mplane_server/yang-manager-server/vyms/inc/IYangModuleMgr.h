...
public:
 ...
 using YangHandlerCallback =
     std::function<bool(const std::string&, std::shared_ptr<DataVariant>)>;
  ...
  */
 virtual Status_E getStatus(void) const = 0;
 virtual void setStatus(Status_E status) = 0;
 ...
 virtual YangResult_E getItem(
     ...
     std::shared_ptr<YangParam>& param) = 0;
 virtual YangResult_E getItem(
     uint32_t moduleId,
     const std::string& xpath,
     std::shared_ptr<YangParam>& param) = 0;
 ...
 virtual YangResult_E getItems(
     const std::string& moduleName,
     const std::string& xpath,
     std::shared_ptr<YangParams>& params) = 0;
 virtual YangResult_E getItems(
     uint32_t moduleId,
     const std::string& xpath,
     std::shared_ptr<YangParams>& params) = 0;
 ...
 virtual bool isFeatureEnabled(
     const std::string& moduleName, const std::string& feature) = 0;
 virtual bool isFeatureEnabled(
     uint32_t moduleId, const std::string& feature) = 0;
 ...
 virtual bool registerCallback(
     uint32_t moduleId,
     const std::string& xpath,
     YangHandlerCallback callback) = 0;
 ...
 virtual bool testCallback(
     uint32_t moduleId,
     const std::string& xpath,
     std::shared_ptr<DataVariant> value) = 0;
} ;
