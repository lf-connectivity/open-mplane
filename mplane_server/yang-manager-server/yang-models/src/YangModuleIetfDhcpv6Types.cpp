...
// -----------------------------------------------------------------------------
GrpVendorInfor::GrpVendorInfor(uint32_t id) : YangGroup("vendor-infor", id) {}

GrpVendorInfor::~GrpVendorInfor() {}

YangResult_E
GrpVendorInfor::initialise(void) {
  // -----------------------------------------------------------------------------
...
YangResult_E
GrpVendorInfor::CntVendorInfo::initialise(void) {
  // -----------------------------------------------------------------------------
...
YangResult_E
GrpVendorInfor::CntVendorInfo::LstData::initialise(void) {
...
// -----------------------------------------------------------------------------
// Grouping:    duid
// Description: Each server and client has only one DUID (DHCP Unique
// Identifier).
//              The DUID here identifies a unique DHCPv6 server for clients.
//              DUID consists of a two-octet type field and an arbitrary length
//              (no more than 128 bytes) content field. Currently there are four
//              defined types of DUIDs in RFC3315 and RFC6355 - DUID-LLT,
//              DUID-EN, DUID-LL and DUID-UUID. DUID-Uknown represents those
//              unconventional DUIDs.
// -----------------------------------------------------------------------------
GrpDuid::GrpDuid(uint32_t id) : YangGroup("duid", id) {}

GrpDuid::~GrpDuid() {}

YangResult_E
GrpDuid::initialise(void) {
  // -----------------------------------------------------------------------------
  // Leaf:        /duid/type-code
...
// Description: Type code of this DUID
// -----------------------------------------------------------------------------
GrpDuid::LeafTypeCode::LeafTypeCode(uint32_t id) : YangLeaf("type-code", id) {}
...
YangResult_E
GrpDuid::ChoiceDuidType::initialise(void) {
...
YangResult_E
GrpDuid::ChoiceDuidType::OptDuidLlt::initialise(void) {
  // -----------------------------------------------------------------------------
  ...
  // Units:
  // -----------------------------------------------------------------------------
  LeafDuidLltLinkLayerAddr duidLltLinkLayerAddrInst(
      ITEM_DUID_LLT_LINK_LAYER_ADDR);
...
// Description: Hardware type as assigned by IANA (RFC826).
// -----------------------------------------------------------------------------
GrpDuid::ChoiceDuidType::OptDuidLlt::LeafDuidLltHardwareType::
...
// Description: Link-layer address as described in RFC2464
// -----------------------------------------------------------------------------
GrpDuid::ChoiceDuidType::OptDuidLlt::LeafDuidLltLinkLayerAddr::
...
YangResult_E
GrpDuid::ChoiceDuidType::OptDuidEn::initialise(void) {
  // -----------------------------------------------------------------------------
  ...
  // Units:
  // -----------------------------------------------------------------------------
  LeafDuidEnEnterpriseNumber duidEnEnterpriseNumberInst(
      ITEM_DUID_EN_ENTERPRISE_NUMBER);
...
//                  maintained by IANA
// -----------------------------------------------------------------------------
GrpDuid::ChoiceDuidType::OptDuidEn::LeafDuidEnEnterpriseNumber::
...
GrpDuid::ChoiceDuidType::OptDuidEn::LeafDuidEnIdentifier::
...
YangResult_E
GrpDuid::ChoiceDuidType::OptDuidLl::initialise(void) {
  // -----------------------------------------------------------------------------
...
// Description: Hardware type as assigned by IANA (RFC826).
// -----------------------------------------------------------------------------
GrpDuid::ChoiceDuidType::OptDuidLl::LeafDuidLlHardwareType::
...
// Description: Link-layer address as described in RFC2464
// -----------------------------------------------------------------------------
GrpDuid::ChoiceDuidType::OptDuidLl::LeafDuidLlLinkLayerAddr::
...
YangResult_E
GrpDuid::ChoiceDuidType::OptDuidUnknown::initialise(void) {
  // -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
GrpPortsetPara::GrpPortsetPara(uint32_t id) : YangGroup("portset-para", id) {}

GrpPortsetPara::~GrpPortsetPara() {}

YangResult_E
GrpPortsetPara::initialise(void) {
  // -----------------------------------------------------------------------------
...
YangResult_E
GrpPortsetPara::CntPortParameter::initialise(void) {
  // -----------------------------------------------------------------------------
...
//              in [RFC3315].
// -----------------------------------------------------------------------------
GrpIaid::GrpIaid(uint32_t id) : YangGroup("iaid", id) {}

GrpIaid::~GrpIaid() {}

YangResult_E
GrpIaid::initialise(void) {
  // -----------------------------------------------------------------------------
...
YangResult_E
GrpIaid::LstIdentityAssociation::initialise(void) {
  // -----------------------------------------------------------------------------
...
GrpIaid::LstIdentityAssociation::LeafPreferredLifetime::
...
YangResult_E
GrpIaid::LstIdentityAssociation::LstIpv6Addr::initialise(void) {
...
YangResult_E
GrpIaid::LstIdentityAssociation::LstIpv6Prefix::initialise(void) {
...
YangResult_E
GrpIaid::LstIdentityAssociation::LstPrefixLength::initialise(void) {
...
ModuleIetfDhcpv6Types::createModule(uint32_t id) {
  std::shared_ptr<YangModule> instance(
      std::make_shared<ModuleIetfDhcpv6Types>(id));
  // assert(instance->getId() != ITEM_NULL);
  return instance;
}

std::shared_ptr<YangModule>
ModuleIetfDhcpv6Types::singleton() {
