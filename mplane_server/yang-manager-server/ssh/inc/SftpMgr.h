...
public:
 ...
 /**
  * User has finished with the session. If no other users are using this session
  * then it will be closed down
  */
  ...
  */
 virtual std::shared_ptr<ISftpSession> factoryCreate(
