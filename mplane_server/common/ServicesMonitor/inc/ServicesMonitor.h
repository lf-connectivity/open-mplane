...
class ServicesMonitor : public IServicesMonitor, public Task {
 ...
 public:
   ...
   */
  virtual IServicesMonitor::ApplicationState getApplicationState()
      const override;
 ...
 protected:
  ...
  /**
   * Update the application state file. The state file is a text file that
   * contains the state of the application. A new line containing the current
   * application state is written each time the state changes. The last line is
