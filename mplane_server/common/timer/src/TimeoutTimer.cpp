...
TimeoutTimer::TimeoutTimer()
    : mDuration(), mCallback(), mTimedOut(false), mEndTime(), mRunning(false) {}
...
//-------------------------------------------------------------------------------------------------------------
void
TimeoutTimer::setTimedCallback(TimerCallback func) {
  mCallback = func;
}
...
//-------------------------------------------------------------------------------------------------------------
void
TimeoutTimer::startTimer(const std::chrono::milliseconds& timerTime) {
  mRunning = true;
  mDuration = timerTime;
