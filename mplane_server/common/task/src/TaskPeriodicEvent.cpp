...
//-------------------------------------------------------------------------------------------------------------
TaskPeriodicEvent::~TaskPeriodicEvent() { shutdown(); }

//-------------------------------------------------------------------------------------------------------------
void
TaskPeriodicEvent::shutdown() {
  if (!mTaskRunning)
    return;
...
//-------------------------------------------------------------------------------------------------------------
bool
Mplane::TaskPeriodicEvent::isEvent() const {
  return !mPeriodicEvent;
}

//-------------------------------------------------------------------------------------------------------------
bool
Mplane::TaskPeriodicEvent::isPeriodic() const {
  return mPeriodicEvent;
}
