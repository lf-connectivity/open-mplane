 ...
 *
 *
 * \details   Set of maths functions that should be in the std library (and
 * possibly are in C++11 onwards!)
 *
 */
...
class Maths {
 public:
   ...
   * @param str
   * @param end    (Optional) when provided with a pointer, method returns the
   * end of the string
   * @return float
   */
  ...
  /**
   * Convert 32 bit representation of single precision floating point into a
   * float
   * @param ieee754
   * @return float
   */
