...
/**
 * This class provides a string tokenisation capability that allows a standard
 * string to be returned as split into a number of string tokens according to
 * the given delimiters.
 */
class Tokeniser {
 public:
  /**
   * Default delimiters, are space, tab, carriage return and line feed "
   * /t/r/l".
   */
