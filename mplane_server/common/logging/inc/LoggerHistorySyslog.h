 ...
 * \brief     An ILogger that outputs to syslog AND stored certain levels into a
 * rolling buffer
 *
 *
 * \details   Derived from LoggerSyslog but also saves any log with level >=
 * specified level into a rolling buffer. This rolling buffer can then be
 * accessed to the application.
 *
 */
