...
LoggerHistorySyslog::LoggerHistorySyslog(
    ...
    : LoggerSyslog(parent, instanceName, groupName),
      mHistory(std::dynamic_pointer_cast<LogHistoryBuffer>(
...
//-------------------------------------------------------------------------------------------------------------
void
LoggerHistorySyslog::eventData(const std::string& eventStr) const {
...
//-------------------------------------------------------------------------------------------------------------
void
LoggerHistorySyslog::eventInfo(const std::string& eventStr) const {
...
//-------------------------------------------------------------------------------------------------------------
void
LoggerHistorySyslog::eventWarning(const std::string& eventStr) const {
...
//-------------------------------------------------------------------------------------------------------------
void
LoggerHistorySyslog::eventError(const std::string& eventStr) const {
...
//-------------------------------------------------------------------------------------------------------------
void
LoggerHistorySyslog::eventFatal(const std::string& eventStr) const {
...
//-------------------------------------------------------------------------------------------------------------
void
LoggerHistorySyslog::logDebugNormal(const std::string& debugStr) const {
...
//-------------------------------------------------------------------------------------------------------------
void
LoggerHistorySyslog::logDebugVerbose(const std::string& debugStr) const {
  mHistory->logData(debugStr);
...
//-------------------------------------------------------------------------------------------------------------
void
LoggerHistorySyslog::dataHourly(
