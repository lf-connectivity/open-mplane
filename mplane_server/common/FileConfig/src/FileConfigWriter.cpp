...
//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::setPath(const std::string& path) {
  return this->FileConfigBase::setPath(path);
}

//-------------------------------------------------------------------------------------------------------------
std::string
FileConfigWriter::filename() const {
  return this->FileConfigBase::filename();
}

//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::isValid() const {
  return this->FileConfigBase::isValid();
}

//-------------------------------------------------------------------------------------------------------------
std::string
FileConfigWriter::value(const std::string& varname) const {
  return this->FileConfigBase::value(varname);
}

//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::isVariable(const std::string& varname) const {
  return this->FileConfigBase::isVariable(varname);
}

//-------------------------------------------------------------------------------------------------------------
std::string
FileConfigWriter::value(
...
//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::isSection(const std::string& section) const {
  return this->FileConfigBase::isSection(section);
}

//-------------------------------------------------------------------------------------------------------------
std::vector<std::string>
FileConfigWriter::sections() const {
  return this->FileConfigBase::sections();
}

//-------------------------------------------------------------------------------------------------------------
std::string
FileConfigWriter::error() {
  return this->FileConfigBase::error();
}

//-------------------------------------------------------------------------------------------------------------
void
FileConfigWriter::show() const {
  this->FileConfigBase::show();
}

//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::modifyValue(
...
//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::modifyValue(const std::string& varname, double value) {
  return this->FileConfigBase::_modifyValue(varname, value);
}
...
//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::modifyValue(const std::string& varname, int value) {
  return this->FileConfigBase::_modifyValue(varname, value);
}
...
//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::setValue(const std::string& varname, double value) {
  return this->FileConfigBase::_setValue(varname, value);
}
...
//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::setValue(const std::string& varname, int value) {
  return this->FileConfigBase::_setValue(varname, value);
}
...
//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::save() {
  return this->FileConfigBase::_save();
}

//-------------------------------------------------------------------------------------------------------------
bool
FileConfigWriter::read() {
