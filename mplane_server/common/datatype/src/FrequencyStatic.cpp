 ...
 *
 *
 * \details   This file contains the implementation common methods used by the
 * template class FrequencyBase
 *
 */
...
//-------------------------------------------------------------------------------------------------------------
const char*
FrequencyStatic::unit2Str(FrequencyStatic::Unit value) {
  switch (value) {
    case Hz:
      return "Hz";
    case THz:
...
//-------------------------------------------------------------------------------------------------------------
FrequencyStatic::Unit
FrequencyStatic::str2unit(const std::string& units) {
