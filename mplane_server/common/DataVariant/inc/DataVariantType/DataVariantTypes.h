 ...
 *
 *
 * \details   Inherits the methods from all supported types into a convenience
 * class so we only have to inherit this in DataVariantBase
 *
 */
...
class DataVariantTypes : public DataVariantFloat,
