...
//----------------------------------------------------------------------------------------------------------------------
/**
 * The Mplane::DataVariant class is derived from Mplane::DataVariantBase and
 * adds support for vectors of Mplane::DataVariant objects
 */
class DataVariant : public DataVariantBase {
 public:
  ...
  /**
   * Returns a list of name / DataVariant pairs (even if DataVariant is not a
   * vector)
   */
   ...
   * @param value
   * @param name    Optional name string. Sets the displayed name of this
   * vector element.
   */
  virtual void set(
  ...
  /**
   * Set the vector entry value of the the variant to the integer value. If the
   * variant is type Float, the value is cast to a float internally.
   *
   * @param index    Index into vector
   * @param value
   * @param name    Optional name string. Sets the displayed name of this
  ...
  /**
   * Set the vector entry value of the variant to the float value. If the
   * variant is type Int, the value is cast to an integer internally.
   *
   * @param index    Index into vector
   * @param value
   * @param name    Optional name string. Sets the displayed name of this
 ...
 public:
   ...
   *     name[XX]
   * If so it sets the index to the XX value, and sets the base string to the
   * 'name' part
   *
   * @param indexedStr    String containing the indexed expression
   * @param index            Set to index value if indexed
   * @param baseStr        Set to the base name of the indexed expression
   * if indexed
 ...
 private:
  /**
   * Use the vector index to get the DataVariant from the vector. If index is
   * larger than current vector size then the vector is expanded. If this
   * DataVariant is not a vector then returns this
   * @param index
  ...
  /**
   * Use the vector index to get the name from the vector. If index is larger
   * than current vector size then the vector is expanded. If this DataVariant
   * is not a vector then returns this name
   * @param index
