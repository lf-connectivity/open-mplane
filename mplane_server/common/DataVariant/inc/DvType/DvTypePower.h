 ...
 *
 * \file      DvTypePower.h
 * \brief     Represents DataVariant type "POWER"
 *
 *
 * \details
 *
...
#ifndef DVTYPEPOWER_H_
#define DVTYPEPOWER_H_
...
class DvTypePower : public virtual IDvPower, public DvTypeBase {
 public:
  using super = DvTypeBase;

  explicit DvTypePower(const std::string& typeStr = "");
  virtual ~DvTypePower();
 ...
 private:
  ...
  Limits<Power> mLimits;
};

} // namespace Mplane

#endif /* DVTYPEPOWER_H_ */
