 ...
 *
 * \file      DvTypeFloat.h
 * \brief     Represents DataVariant type "FLOAT"
 *
 *
 * \details
 *
...
#ifndef DvTypeFloat_H_
#define DvTypeFloat_H_
...
class DvTypeFloat : public virtual IDvFloat, public DvTypeBase {
 public:
  explicit DvTypeFloat(const std::string& typeStr = "");
  virtual ~DvTypeFloat();
