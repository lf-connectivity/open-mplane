 ...
 *
 *
 * \details   Virtual interface that provides methods to convert to/from
 * specific type from/to a common type. To support all possible types, we need
 * the common "type" to be either an array of long long or an array of double
 *
 */
