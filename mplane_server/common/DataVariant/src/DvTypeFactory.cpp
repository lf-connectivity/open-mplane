...
//-------------------------------------------------------------------------------------------------------------
// Order of types is used when trying to determine the type from a string. Each
// type is passed the string to see if that string is valid for the type. The
// first type that can accept the string is used.
...
//-------------------------------------------------------------------------------------------------------------
std::vector<std::shared_ptr<IDvType>>
DvTypeFactory::getTypes() {
...
//-------------------------------------------------------------------------------------------------------------
std::shared_ptr<IDvType>
DvTypeFactory::factory(DataVariantType::Type type, const std::string& typeStr) {
...
//-------------------------------------------------------------------------------------------------------------
std::shared_ptr<IDvType>
DvTypeFactory::factory(const std::string& typeStr) {
  // Uses the singleton list of all known types to call "static" methods to see
  // if we can create a type using this type string
...
//-------------------------------------------------------------------------------------------------------------
std::shared_ptr<IDvType>
DvTypeFactory::copy(std::shared_ptr<IDvType> rhs) {
