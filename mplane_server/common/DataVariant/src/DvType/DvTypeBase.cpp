...
DvTypeBase::DvTypeBase(const std::string& typeStr)
    : mTypeStr(typeStr), mIsSet(false), mStr(""), mUnits("") {}
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::canHaveUnits() const {
  return false;
}

//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::isSet() const {
  return mIsSet;
}
...
//-------------------------------------------------------------------------------------------------------------
std::string
DvTypeBase::toString() const {
  return mStr;
}

//-------------------------------------------------------------------------------------------------------------
std::string
DvTypeBase::getValue() const {
...
//-------------------------------------------------------------------------------------------------------------
const std::string
DvTypeBase::getLimitsStr() const {
  return "";
}

//-------------------------------------------------------------------------------------------------------------
const std::string
DvTypeBase::getLimitsMin() const {
  return "";
}

//-------------------------------------------------------------------------------------------------------------
const std::string
DvTypeBase::getLimitsMax() const {
  return "";
}

//-------------------------------------------------------------------------------------------------------------
const std::string
DvTypeBase::getLimitsStep() const {
  return "";
}

//-------------------------------------------------------------------------------------------------------------
const bool
DvTypeBase::isHex() const {
  return false;
}

//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::setLimits(const std::string& limitsStr) {
  return true;
}

//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::setLimits(
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::checkLimits(std::string& error) {
  return true;
}

//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::checkLimits() {
  std::string error;
...
//-------------------------------------------------------------------------------------------------------------
void
DvTypeBase::setUnits(const std::string& units) {
  mUnits = units;
}

//-------------------------------------------------------------------------------------------------------------
const std::string
DvTypeBase::getUnits() const {
  return mUnits;
}
...
//-------------------------------------------------------------------------------------------------------------
std::string
DvTypeBase::getInitialTypeStr() const {
  return mTypeStr;
}

//-------------------------------------------------------------------------------------------------------------
void
DvTypeBase::setStr(const std::string& str) {
  mIsSet = true;
  mStr = str;
}
...
//-------------------------------------------------------------------------------------------------------------
void
DvTypeBase::setStr(const IDvAccess::InterInt& ival) {
  setStr(intToStr(ival));
}

//-------------------------------------------------------------------------------------------------------------
void
DvTypeBase::setStr(const IDvAccess::InterFloat& fval) {
  setStr(floatToStr(fval));
}

//-------------------------------------------------------------------------------------------------------------
void
DvTypeBase::setStr(int ival) {
  setStr(intToStr(ival));
}

//-------------------------------------------------------------------------------------------------------------
void
DvTypeBase::setStr(float fval) {
  setStr(floatToStr(fval));
}

//-------------------------------------------------------------------------------------------------------------
void
DvTypeBase::setStr(const std::complex<float>& complex) {
  setStr(complexToStr(complex));
}

//-------------------------------------------------------------------------------------------------------------
std::string
DvTypeBase::unitsFromStr(const std::string& value) {
  ...
  // Check valid units
  if (!unitsStr.empty()) {
    // Only allow units to be set if (a) no type defined yet, or (b) type
    // defined AND default units are set so fail if type defined AND no default
    // units
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::strIsHex(const std::string& value) {
  if (value.size() < 3)
    return false;
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::strIsNumber(const std::string& value) {
  if (value.empty())
    return false;

  // Generic check to see if this string starts with a valid INT or FLOAT (Does
  // NOT do complete check)
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::strIsUnsigned(const std::string& value) {
  if (value.empty())
    return false;
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::strIsInt(const std::string& value) {
  if (value.empty())
    return false;
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::strIsFloat(const std::string& value) {
  // if the string contains a decimal point assume it is a float - need at least
  // 2 chars to check this
  if (value.size() < 2)
    return false;
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::strIsBool(const std::string& value) {
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::strToBool(const std::string& value) {
  std::string lower(toLower(value));
...
DvTypeBase::strToEnum(const std::string& str) {
...
//-------------------------------------------------------------------------------------------------------------
bool
DvTypeBase::strIsComplex(
    const std::string& value, std::complex<float>& complexVal) {
  // General form is:
  ...
  // <real> can be omitted, but imaginary part must always be specified even if
  // 0
  //
...
//-------------------------------------------------------------------------------------------------------------
std::string
DvTypeBase::complexToStr(const std::complex<float>& complex) {
  std::string sep("+j");
...
//-------------------------------------------------------------------------------------------------------------
std::string
DvTypeBase::floatToStr(const IDvAccess::InterFloat& fval) {
  std::stringstream ss;
  ss << std::fixed << fval;
...
//-------------------------------------------------------------------------------------------------------------
std::string
Mplane::DvTypeBase::intToStr(const IDvAccess::InterInt& ival) {
  std::stringstream ss;
  ss << ival;
  return trim_float(ss.str());
}
...
//-------------------------------------------------------------------------------------------------------------
std::string
DvTypeBase::floatToStr(float fval) {
  std::stringstream ss;
  ss << std::fixed << fval;
  return trim_float(ss.str());
}
...
//-------------------------------------------------------------------------------------------------------------
std::string
Mplane::DvTypeBase::intToStr(int ival) {
  std::stringstream ss;
  ss << ival;
  return trim_float(ss.str());
}
