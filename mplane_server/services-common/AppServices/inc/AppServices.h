 ...
 *
 *
 * \details   Manages the services that run for any particular application.
 * Application specific code just needs to register it's own services, all
 * common behaviour is handled by this common class
 *
 */
...
class AppServices : public IServicesCtl, public Loggable {
 public:
   ...
   * @return true if registered ok
   */
  virtual bool registerMiscService(
      IServicesCtl::MiscServiceSingletonCreate create) override;
