...
class Crypt {
 public:
  ...
  //    /**
  //     * Encrypt the input data
  //     * @param headerLen Number of header bytes to skip. These bytes are
  // copied as-is from input to output
  //     * @param inData
  //     * @param outData
  //     */
  //    bool encrypt(unsigned headerLen, const std::vector<uint8_t>& inData,
  // std::vector<uint8_t>& outData) ;
  //
  //    /**
  //     * Decrypt the input data
  ...
  //     * @param outData
  //     */
  //    bool decrypt(unsigned headerLen, const std::vector<uint8_t>& inData,
  // std::vector<uint8_t>& outData) ;
  //
