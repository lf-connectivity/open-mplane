...
CaptureWaveHeader::CaptureWaveHeader()
    : WaveFileHeader(), mWaveIndex(0), mSampleRateKsps(0) {}
...
//-------------------------------------------------------------------------------------------------------------
unsigned
CaptureWaveHeader::getHeaderSize() const {
  return CAPTURE_HEAD_LEN + this->super::getHeaderSize();
}

//-------------------------------------------------------------------------------------------------------------
bool
CaptureWaveHeader::processHeader(
...
//-------------------------------------------------------------------------------------------------------------
unsigned
CaptureWaveHeader::getWaveIndex() const {
  return mWaveIndex;
}

//-------------------------------------------------------------------------------------------------------------
unsigned
CaptureWaveHeader::getSampleRateKsps() const {
  return mSampleRateKsps;
}

//-------------------------------------------------------------------------------------------------------------
bool
CaptureWaveHeader::createHeader(
  ...
  if (!this->super::createHeader(
          data, IWaveFile::WaveType::CAPTURE, CAPTURE_HEAD_LEN))
    return false;
