 ...
 *
 *
 * \details   Provides generic functionality that all ILogger classes must implement
 *
 */
...
{
public:
	LoggerBase(ILoggable* parent, const std::string& instanceName, const std::string& groupName) ;
...
protected:
	 ...
	 */
	ILoggable* getParent() const { return mParent; }
