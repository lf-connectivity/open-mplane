...
//-------------------------------------------------------------------------------------------------------------
void ILogger::setLogConsole(bool consoleLogging)
{
	Mutex::Lock lock(LoggerSyslog::mMutex) ;
...
//-------------------------------------------------------------------------------------------------------------
bool ILogger::setForwarding(const std::string& host)
{
	Mutex::Lock lock(LoggerSyslog::mMutex) ;
...
//-------------------------------------------------------------------------------------------------------------
std::string ILogger::getForwarding()
{
	Mutex::Lock lock(LoggerSyslog::mMutex) ;
...
//-------------------------------------------------------------------------------------------------------------
LoggerSyslog::LoggerSyslog(ILoggable* parent, const std::string& instanceName, const std::string& groupName) :
...
//-------------------------------------------------------------------------------------------------------------
void LoggerSyslog::eventData(const std::string& eventStr) const
{
...
//-------------------------------------------------------------------------------------------------------------
void LoggerSyslog::eventInfo(const std::string& eventStr) const
{
...
//-------------------------------------------------------------------------------------------------------------
void LoggerSyslog::eventWarning(const std::string& eventStr) const
{
...
//-------------------------------------------------------------------------------------------------------------
void LoggerSyslog::eventError(const std::string& eventStr) const
{
...
//-------------------------------------------------------------------------------------------------------------
void LoggerSyslog::eventFatal(const std::string& eventStr) const
{
...
//-------------------------------------------------------------------------------------------------------------
void LoggerSyslog::dataHourly(const std::string& dataSource, const std::string& dataStr) const
{
...
//-------------------------------------------------------------------------------------------------------------
void LoggerSyslog::dataDaily(const std::string& dataSource, const std::string& dataStr) const
{
...
//-------------------------------------------------------------------------------------------------------------
void LoggerSyslog::logDebugNormal(const std::string& debugStr) const
{
...
//-------------------------------------------------------------------------------------------------------------
void LoggerSyslog::logDebugVerbose(const std::string& debugStr) const
{
	std::string str(std::string("[DEBUG] ") + debugStr) ;
	::syslog(LOG_DEBUG, "%s", str.c_str()) ;
