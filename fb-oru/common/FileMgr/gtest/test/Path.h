...
public:
	...
	/**
	 * Create a link from 'src' to 'link'. 'link' is the full path to the link, 'src' is the contents of the
	 * link (i.e. what the link links to)
	 *
	 * @param link the path to the symbolic link to be created
	 * @param src what the link points to
	 * @return true if able to create link
	 */
	static bool createLink(const std::string& link, std::string src);
