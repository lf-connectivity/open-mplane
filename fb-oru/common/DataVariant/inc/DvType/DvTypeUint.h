...
public:
    ...
    /**
     * Sets limits for either an INT or UINT type ; does nothing for any other type
    ...
    /**
     * Check the INT/UINT type current value against any set limits. Note that this method may adjust the value
...
private:
    unsigned mUint;		//<! UINT
    bool mIsHex;     	//<! is set the value as string represents the integer value in hex
