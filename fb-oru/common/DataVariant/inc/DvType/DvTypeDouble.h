...
public:
    ...
    /**
     * Sets limits for either an INT or DOUBLE type ; does nothing for any other type
    ...
    /**
     * Check the INT/DOUBLE type current value against any set limits. Note that this method may adjust the value
