...
std::shared_ptr<IDataVariantSettings> IDataVariantSettings::getInstance()
{
	static std::shared_ptr<IDataVariantSettings> instance(std::make_shared<DataVariantSettingsInstance>()) ;
	return instance ;
}
...
//-------------------------------------------------------------------------------------------------------------
void DataVariantSettings::clearSettings()
{
	mSettings.clear() ;
}

//-------------------------------------------------------------------------------------------------------------
void DataVariantSettings::registerSettings(const std::map<std::string, std::string>& settings)
{
	mSettings = settings ;
}

//-------------------------------------------------------------------------------------------------------------
bool DataVariantSettings::setSetting(const std::string& name, const std::string& value)
{
	if (!isSetting(name))
		return false ;
...
//-------------------------------------------------------------------------------------------------------------
std::string DataVariantSettings::expandString(const std::string& str, std::string& error)
{
	error = "" ;
	if (mSettings.empty())
		return str ;
...
//-------------------------------------------------------------------------------------------------------------
bool Mplane::DataVariantSettings::isSetting(const std::string& name) const
{
