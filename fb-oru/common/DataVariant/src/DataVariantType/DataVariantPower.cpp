...
//-------------------------------------------------------------------------------------------------------------
bool DataVariantPower::setPower(const Power& value)
{
	...
	return mDvRef->fromInterFloat(static_cast<IDvAccess::InterFloat>(value.get())) ;
}

//-------------------------------------------------------------------------------------------------------------
Power DataVariantPower::toPower() const
{
