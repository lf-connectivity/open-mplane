...
//-------------------------------------------------------------------------------------------------------------
bool DataVariantFreq::setFreq(const Frequency& value)
{
	...
	return mDvRef->fromInterFloat(static_cast<IDvAccess::InterFloat>(value.getDbl())) ;
}

//-------------------------------------------------------------------------------------------------------------
Frequency DataVariantFreq::toFreq() const
{
