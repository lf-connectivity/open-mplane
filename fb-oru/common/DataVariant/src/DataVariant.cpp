...
//-------------------------------------------------------------------------------------------------------------
DataVariant::DataVariant(const DataVariantType::Type& type, const std::string& name, const std::string& value) :
...
DataVariant& DataVariant::operator =(const DataVariant& rhs)
{
	...
	// copy vector
	for (ValuesConstIter iter(rhs.mValues.begin()); iter != rhs.mValues.end(); ++iter)
	{
		mValues.push_back(new DataVariantBase(**iter)) ;
	}
	for (NamesConstIter iter(rhs.mNames.begin()); iter != rhs.mNames.end(); ++iter)
	{
...
//-------------------------------------------------------------------------------------------------------------
bool DataVariant::isVector() const
{
	return mIsVector ;
}

//-------------------------------------------------------------------------------------------------------------
unsigned DataVariant::size() const
{
	return mValues.size() ;
}

//-------------------------------------------------------------------------------------------------------------
std::vector< std::pair<std::string, DataVariant> > DataVariant::getList() const
{
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::set(const DataVariant & rhs)
{
	operator=(rhs) ;
}
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::set(const std::shared_ptr<DataVariant>& rhs)
{
	operator=(*rhs) ;
}
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::set(unsigned index, const std::string& value, const std::string& name)
{
	// vector only
	if (!mIsVector)
		return ;
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::set( unsigned index, int value, const std::string& name )
{
	// vector only
	if (!mIsVector)
		return ;
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::set( unsigned index, float value, const std::string& name )
{
	// vector only
	if (!mIsVector)
		return ;
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::set(unsigned index, const std::complex<float>& value, const std::string& name)
{
	// vector only
	if (!mIsVector)
		return ;
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::setName( unsigned index, const std::string& name )
{
	// vector only
	if (!mIsVector)
		return ;
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::set(const std::string& value)
{
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::set( int value )
{
	this->super::setInt(value) ;
}

//-------------------------------------------------------------------------------------------------------------
void DataVariant::set( float value )
{
	this->super::setFloat(value) ;
}

//-------------------------------------------------------------------------------------------------------------
void DataVariant::set(const std::complex<float>& value)
{
	this->super::setComplex(value) ;
}

//-------------------------------------------------------------------------------------------------------------
std::string DataVariant::getNameValuePair() const
{
...
//-------------------------------------------------------------------------------------------------------------
std::string DataVariant::getNameValuePairOptional() const
{
...
//-------------------------------------------------------------------------------------------------------------
std::vector<std::string> DataVariant::toStrings() const
{
...
//-------------------------------------------------------------------------------------------------------------
std::vector<std::string> DataVariant::toStringsFull() const
{
	std::vector<std::string> result;
...
//-------------------------------------------------------------------------------------------------------------
const std::string DataVariant::getTypeStr() const
{
...
//-------------------------------------------------------------------------------------------------------------
bool DataVariant::setLimits(const std::string& limitsStr)
{
	if (!mIsVector)
		// scalar set
...
//-------------------------------------------------------------------------------------------------------------
bool DataVariant::setLimits(const std::string& minStr, const std::string& maxStr, const std::string& stepStr)
{
	if (!mIsVector)
		// scalar set
...
//-------------------------------------------------------------------------------------------------------------
bool DataVariant::checkLimits(std::string& error)
{
	if (!mIsVector)
		// scalar check
...
//-------------------------------------------------------------------------------------------------------------
void DataVariant::setUnits(const std::string& units)
{
...
//-------------------------------------------------------------------------------------------------------------
bool DataVariant::getIndex(const std::string& indexedStr, unsigned& index, std::string& baseStr)
{
	...
	if ((idxStart == std::string::npos) || (idxStart == 0) || (idxStart == indexedStr.length()-1))
		return false ;
...
//-------------------------------------------------------------------------------------------------------------
DataVariantBase& DataVariant::getIndexedValue(unsigned index)
{
	if (!mIsVector)
		return *this ;
...
//-------------------------------------------------------------------------------------------------------------
std::string& DataVariant::getIndexedName(unsigned index)
{
	if (!mIsVector)
		return mName ;
