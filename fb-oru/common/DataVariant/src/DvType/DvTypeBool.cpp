...
DvTypeBool::DvTypeBool(const std::string& typeStr) :
	DvTypeEnum( (typeStr.empty()  || (typeStr == TYPE_STR)) ? (TYPE_STR + BOOL_ENUM_STR) : typeStr)
{
...
//-------------------------------------------------------------------------------------------------------------
bool DvTypeBool::canSetValue(const std::string& value) const
{
	if (strIsBool(value))
		return true ;
	return false ;
...
//-------------------------------------------------------------------------------------------------------------
bool DvTypeBool::canSetType(const std::string& typeStr) const
{
...
//-------------------------------------------------------------------------------------------------------------
const std::string DvTypeBool::getTypeStr() const
{
...
//-------------------------------------------------------------------------------------------------------------
const DataVariantType::Type DvTypeBool::getType() const
{
	return DataVariantType::Bool ;
}

//-------------------------------------------------------------------------------------------------------------
bool DvTypeBool::set(const std::string& value)
{
	// Try using ENUM
...
//-------------------------------------------------------------------------------------------------------------
bool Mplane::DvTypeBool::setBool(bool value)
{
	return setEnumValue( value ? 1 : 0 ) ;
}

//-------------------------------------------------------------------------------------------------------------
bool Mplane::DvTypeBool::toBool() const
{
