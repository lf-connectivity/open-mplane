 ...
 *
 * \file      AlarmBuilder_unittest.cpp
 * \brief     Google Test of AlarmBuilder
 *
 *
 * \details   This file contains the implementation of the Google Test test cases
 *            for the AlarmBuilder class.
 *
 */
...
TEST(AlarmBuilder, Test)
{
	...
	// create alarm builder
	std::shared_ptr<IAlarmBuilder> alarmBuilder(std::make_shared<AlarmBuilder1>()) ;
