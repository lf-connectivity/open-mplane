 ...
 *
 * \file      FaultPackage_unittest.cpp
 * \brief     Google Test of FaultPackage
 *
 *
 * \details   This file contains the implementation of the Google Test test cases
 *            for the FaultPackage class.
 *
 */
...
TEST(FaultPackage, Simple)
{
	...
	// Create the package
	std::shared_ptr<IFaultPackage> faultPackage(std::make_shared<FaultPackage1>()) ;
