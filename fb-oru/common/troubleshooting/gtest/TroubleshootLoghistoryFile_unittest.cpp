 ...
 *
 * \file      TroubleshootLoghistoryFile_unittest.cpp
...
//===================================================================================================================
class TroubleshootLoghistoryFileTest : public ::testing::Test
{
public:
...
//-------------------------------------------------------------------------------------------------------------------
TEST_F(TroubleshootLoghistoryFileTest, create)
{
	Path::remove("./test1.log") ;

	TroubleshootLoghistoryFile tsf("test1.log") ;
...
//-------------------------------------------------------------------------------------------------------------------
TEST_F(TroubleshootLoghistoryFileTest, file)
{
	Path::remove("./test2.log") ;

	std::shared_ptr<TroubleshootLoghistoryFile> tsf(std::make_shared<TroubleshootLoghistoryFile>("test2.log")) ;
	EXPECT_TRUE(tsf->empty()) ;
