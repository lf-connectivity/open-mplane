 ...
 *
 *
 * \details   Interface to class that provides log suppport
 *
 */
...
public:
	 ...
	 * @param loggableParent	Pointer to the parent object (so ILogger can call it's ILoggable methods)
	 ...
	 */
	static std::shared_ptr<ILogger> factory(ILoggable* loggableParent, const std::string& instanceName, const std::string& groupName) ;
