 ...
 *
 *
 * \details   Provides the methods for loggable objects. Also provides the ILogger log methods
 *
 */
...
class ILoggable : public virtual ILogEvent, public virtual ILogDebug, public virtual ILogData
{
public:
	ILoggable() {}
	virtual ~ILoggable() {}
	 ...
	 * @param level Level of logging - if the requested log is at or greater than this level then it will be logged
	 */
	 ...
	 */
	static bool setGroupLogDebugLevel(LogDebugLevel level, const std::string& groupName) ;
	 ...
	 */
	static bool setInstanceLogDebugLevel(LogDebugLevel level, const std::string& instanceName) ;
	 ...
	 * @param host	Name or ip of host to forward logs to. If empty then disables forwarding
	 ...
	 * log a fatal error with extra debug information (and terminate)
	 */
	static void logEventFatal( char const* filename, int line, unsigned long errNumber, char const* fmt, ... )
	 ...
	 */
	static void logDataHourly(const std::string& dataSource, const std::string& dataStr) ;
	 ...
	 * @param dataStr		String to log
	 */
	static void logDataDaily(const std::string& dataSource, const std::string& dataStr) ;
