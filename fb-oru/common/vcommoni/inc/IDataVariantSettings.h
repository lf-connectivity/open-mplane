...
public:
	 ...
	 * @param settings
	 */
	virtual void registerSettings(const std::map<std::string, std::string>& settings) =0 ;
	 ...
	 */
	virtual bool setSetting(const std::string& name, const std::string& value) =0 ;
	 ...
	 */
	virtual std::string expandString(const std::string& str, std::string& error) =0 ;
} ;
