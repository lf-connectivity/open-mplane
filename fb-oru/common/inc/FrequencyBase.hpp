 ...
 *
 *
 * \details   This file defines general purpose radio frequency wrapper data. (Ported from original static file)
 *
 */
...
public:
     ...
     * trace("Frequency is %f %s",f1.getDbl( Frequency::MHz ), f1.unit2Str( Frequency::MHz) );
     * @endcode
     *
     *
 ...
 * of megahertz.
 * To ensure no data loss, the frequency needs to be held internal as at least an
 ...
 */
template <typename T>
class FrequencyBase : public FrequencyStatic, public ComparisonOperators< FrequencyBase<T> >
{
public:
    ...
    template <typename U> friend class FrequencyBase ;
     ...
     * @param unit default to hertz but can be overridden to any Frequency::Unit type
     */
    FrequencyBase<T>(double dFrequency, FrequencyBase::Unit unit = FrequencyBase::Hz)
    {
        m_frequency = static_cast<T>(dFrequency * ((double) unit));
    }

    /**
     * Method that allows the frequency of the object to be set using an unsigned integer
     * value. (the equals = operator would normally be used where no unit scaling is required).
     *
     * @code
     * Frequency f1;
     ...
     * @param unit default to hertz but can be overridden to any Frequency::Unit type
     */
    void set(double frequency, FrequencyBase::Unit unit = FrequencyBase::Hz)
    {
     ...
     * @param unit
     */
    void set(const std::string& frequency, FrequencyBase::Unit unit = FrequencyBase::Hz)
    {
    ...
    /**
     * Method used to retrieve the current frequency value as an unsigned integer, by default
     ...
     */
    UintType getUint(FrequencyBase::Unit unit = FrequencyBase::Hz) const
    {
    ...
    /**
     * Method used to retrieve the current frequency value as an integer, by default
     * in hertz. The unit parameter may be used to change the unit type returned.
     *
     * @code
     * Frequency fconst(1234, Frequency::MHz);
     ...
     * @return frequency in the selected units
     */
    IntType getInt(FrequencyBase::Unit unit = FrequencyBase::Hz) const
    {
        double dscaledFreq =  ((double) m_frequency / (double) unit);
    ...
    /**
     * Method used to retrieve the current frequency value as a double precision float, by default
     * in hertz. The unit parameter may be used to change the unit type returned.
     *
     * @code
     ...
     * @return frequency in the selected units.
     */
    double getDbl(FrequencyBase::Unit unit = FrequencyBase::Hz) const
    {
     ...
     * @return frequency in the selected units
     */
    T get(FrequencyBase::Unit unit = FrequencyBase::Hz) const
    {
        double dscaledFreq =  ((double) m_frequency / (double) unit);
        int sign = 1 ;
        if (dscaledFreq < 0.0)
        ...
        dscaledFreq =  (dscaledFreq - floor(dscaledFreq) < 0.5 ? floor(dscaledFreq) : ceil(dscaledFreq));
     ...
     */
    FrequencyBase<T> operator+(const FrequencyBase<T> & rhs) const
    {
        return FrequencyBase<T>(m_frequency + rhs.m_frequency );
    }

    /**
     * Operator overload to allow and unsigned integer to be added to a Frequency object.
     *
     * @code
     * Frequency f1;
     * Frequency f2=100;
     ...
     */
    FrequencyBase<T> operator+(const UintType frequency) const
    {
        return FrequencyBase<T>(m_frequency + static_cast<T>(frequency) );
    }

    /**
     * Operator overload to allow a Frequency object to be added to an existing frequency.
     *
     * @code
     * Frequency f1=200;
     * Frequency f2=2000;
     ...
     * @return reference to the modified Frequency object
     */
    FrequencyBase<T> operator+=(const FrequencyBase<T> & rhs)
	{
    ...
    /**
     * Operator overload to allow an unsigned int to be added to an existing Frequency object.
     *
     * @code
     * Frequency f1=200;
     * f1 += 2000; // result 2200
     ...
     * @return reference to the modified Frequency object
     */
    FrequencyBase<T> operator+=(const UintType frequency)
	{
    ...
    /**
     * Operator overload to allow and unsigned integer to be multiplied by a Frequency object.
     *
     * @code
     * Frequency f1;
     * Frequency f2=100;
    ...
    /**
     * Operator overload to allow a Frequency object to be multiplied by an existing frequency.
     *
     * @code
     * Frequency f1=200;
     * Frequency f2=10;
    ...
    /**
     * Operator overload to allow an unsigned int to be multiplied by an existing Frequency object.
     *
     * @code
     * Frequency f1=200;
     * f1 *= 10; // result 2000
    ...
    /**
     * Operator overload to allow and unsigned integer to be divided by a Frequency object.
     *
     * @code
     * Frequency f1;
     * Frequency f2=100
    ...
    /**
     * Operator overload to allow a Frequency object to be divided by an existing frequency.
     *
     * @code
     * Frequency f1=200;
     * Frequency f2=10;
    ...
    /**
     * Operator overload to allow an unsigned int to divided by an existing Frequency object.
     *
     * @code
     * Frequency f1=200;
     * f1 /= 10; // result 20
    ...
    /**
     * Operator overload to allow a Frequency object to be subtracted from another Frequency object.
     *
     * @code
     * Frequency f1=300;;
     * Frequency f2=100;
    ...
    /**
     * Operator overload to allow an unsigned integer to be subtracted from another Frequency object.
     *
     * @code
     * Frequency f1=300;;
    ...
    /**
     * Operator overload to allow a Frequency object to be subtracted from an existing Frequency.
     *
     * @code
     * Frequency f1=2200;
     * Frequency f2=1000;
    ...
    /**
     * Operator overload to allow an unsigned integer to be subtracted from an existing Frequency.
     *
     * @code
     * Frequency f1=2200;
     * f1 -= 1000; // result 1200
    ...
    /**
     * Assignment operator to allow the value of a Frequency object to be set by another.
     *
     * @code
     * Frequency f1;
     * Frequency f2 = f1;
    ...
    /**
     * Assignment operator to allow the value of a Frequency object to be set by an unsigned integer.
     *
     * @code
     * Frequency f1;
     * f1 = 5000;
     ...
     */
    virtual bool operator==(const FrequencyBase<T> & rhs) const
	{
    ...
    /**
     * Truncates this frequency to the nearest integer multiple of the raster frequency
     * @param raster
     */
    virtual void setRaster(const FrequencyBase<T>& raster)
	{
...
protected:
    ...
    /**
     * Hook called when value will be going negative. For types that don't support negative values, you can either
     * return 0 or throw an exception here (or handle it in some other way)
     * @param val	New value to be checked
     * @return possibly modified value to use
     */
    virtual T negativeValue(const T val) const {return val ;}
