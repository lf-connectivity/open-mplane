...
private:
    ...
    /**
     * @note: Standard copy constructors defined but not implemented as recursive mutex
     * cannot be copied.
     */
...
/**
 * A Resource Allocation Is Initialisation (RAII) implementation of the RecursiveMutex
