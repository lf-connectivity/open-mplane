...
public:
	FileConfig(const std::map<std::string, std::string> defaults = std::map<std::string, std::string>{}) ;
	FileConfig(const std::string& path, const std::map<std::string, std::string> defaults = std::map<std::string, std::string>{}) ;
	virtual ~FileConfig() ;
	 ...
	 * @return value if variable is preset; 0.0 otherwise
	 */
	virtual double doubleValue(const std::string& section, const std::string& varname) const override ;
	 ...
	 * @return value if variable is preset; 0 otherwise
	 */
	virtual int intValue(const std::string& section, const std::string& varname) const override ;
