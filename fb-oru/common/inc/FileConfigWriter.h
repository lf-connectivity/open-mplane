...
public:
	FileConfigWriter(const std::map<std::string, std::string> defaults = std::map<std::string, std::string>{}) ;
	FileConfigWriter(const std::string& path, const std::map<std::string, std::string> defaults = std::map<std::string, std::string>{}) ;
	 ...
	 * @return TRUE if file read ok; FALSE otherwise (use error() method to get error string)
	 */
	 ...
	 * @return value string if variable is preset; empty string otherwise
	 */
	virtual std::string value(const std::string& section, const std::string& varname) const override ;

	/**
	 * is the section variable available?
	 */
	virtual bool isVariable(const std::string& section, const std::string& varname) const override ;
	 ...
	 */
	virtual bool modifyValue(const std::string& varname, const std::string& value) ;

	/**
	 * Modify an already existing value. Returns FALSE if value doesn't exist
	 */
	virtual bool modifyValue(const std::string& section, const std::string& varname, const std::string& value) ;
	 ...
	 * Modify an already existing value. Returns FALSE if value doesn't exist
	 */
	virtual bool modifyValue(const std::string& section, const std::string& varname, double value) ;
	 ...
	 * Modify an already existing value. Returns FALSE if value doesn't exist
	 */
	virtual bool modifyValue(const std::string& section, const std::string& varname, int value) ;


	/**
	 * Set value. Creates a new value if it doesn't already exist; otherwise modifies the existing value
	 */
	 ...
	 * Set value. Creates a new value if it doesn't already exist; otherwise modifies the existing value
	 */
	virtual bool setValue(const std::string& section, const std::string& varname, const std::string& value) ;
	 ...
	 * Set value. Creates a new value if it doesn't already exist; otherwise modifies the existing value
	 */
	virtual bool setValue(const std::string& section, const std::string& varname, double value) ;
	 ...
	 * Set value. Creates a new value if it doesn't already exist; otherwise modifies the existing value
	 */
	virtual bool setValue(const std::string& section, const std::string& varname, int value) ;
