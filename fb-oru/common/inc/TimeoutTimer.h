 ...
 *
 *
 * \details   A timer is initialised to a specified amount of time and, when started, counts down from this time to 0. Once the timer
 * 			reaches 0 it has timed out.
 *
 * 			This class can be created with a timer value and will immediately start timing down. Or it can be created with no time and
 * 			the timer value set. The class can be reused to re-time the existing timer value or set to time new values.
 *
 */
