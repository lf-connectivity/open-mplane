...
public:
	...
	/**
	 * Set the temperature value from a string, useful when creating temperature constants from
	 * parsed text.
	 *
	 * @param temperature
	 */
    ...
    /**
     * Assignment operator to allow the value of a Temperature object to be set by another.
     *
     * @code
     * Temperature p1;
     * Temperature p2 = p1;
    ...
    /**
     * Assignment operator to allow the value of a Temperature object to be set by a
    ...
    /**
     * Assignment operator to allow the value of a Temperature object to be set by a
     * signed integer as raw data using a y=(m*x)+c, where the m is defined by the slope
     * and c is defined by the offset in the constructor.
     *
     * @code
     * Temperature p1;
     * p1 = 50;
    ...
    /**
     * Operator overload to allow a floating point value to be added to a Temperature object.
     *
     * @code
     * Temperature p1;
     * Temperature p2=10.0;
    ...
    /**
     * Operator overload to allow a signed integer to be added to a Temperature object.
     *
     * @code
     * Temperature p1;
     * Temperature p2=10.0;
    ...
    /**
     * Operator overload to allow a Temperature object to be added to an existing temperature.
     *
     * @code
     * Temperature p1=20;
     * Temperature p2=33;
    ...
    /**
     * Operator overload to allow a signed int to be added to an existing Temperature object.
     *
     * @code
     * Temperature p1=21;
     * p1 += 22; // result 43.0
    ...
    /**
     * Operator overload to allow a signed integer to be multiplied by a Temperature object.
     *
     * @code
     * Temperature p1;
     * Temperature p2=100;
    ...
    /**
     * Operator overload to allow a Temperature object to be multiplied by an existing temperature.
     *
     * @code
     * Temperature p1=20;
     * Temperature p2=10;
    ...
    /**
     * Operator overload to allow a signed int to be multiplied by an existing Temperature object.
     *
     * @code
     * Temperature p1=20;
     * p1 *= 11; // result 220
    ...
    /**
     * Operator overload to allow a signed integer to be divided by a Temperature object.
     *
     * @code
     * Temperature p1;
     * Temperature p2=100
    ...
    /**
     * Operator overload to allow a Temperature object to be divided by an existing temperature.
     *
     * @code
     * Temperature p1=200;
     * Temperature p2=10;
    ...
    /**
     * Operator overload to allow a signed int to divided by an existing Temperature object.
     *
     * @code
     * Temperature p1=200;
     * p1 /= 10; // result 20
    ...
    /**
     * Operator overload to allow a Temperature object to be subtracted from another Temperature object.
     *
     * @code
     * Temperature p1=20.0;
     * Temperature p2=10.0;
    ...
    /**
     * Operator overload to allow a signed integer to be subtracted from another Temperature object.
     *
     * @code
     * Temperature p1;
     * Temperature p2=10.0;
    ...
    /**
     * Operator overload to allow a Temperature object to be subtracted from an existing Temperature.
     *
     * @code
     * Temperature f1=220;
     * Temperature f2=100;
    ...
    /**
     * Operator overload to allow a floating point value to be subtracted from an existing Temperature.
     *
     * @code
     * Temperature f1=210;
     * f1 -= 100; // result 110
    ...
    /**
     * Operator overload to allow a signed integer to be subtracted from an existing Temperature.
     *
     * @code
     * Temperature f1=210;
     * f1 -= 100; // result 110
