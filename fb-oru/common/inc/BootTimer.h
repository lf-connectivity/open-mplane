...
public:
	...
	/**
	 * This marks the time at which the application has completely started. Stops all running timers.
	 */
	...
	/**
	 * Get the elapsed time from the start of the application at which the tif interface is ready
	...
	/**
	 * Get the elapsed time from the start of the application at which the application is ready
	 * @return the elapsed time in seconds
	 */
	...
	/**
	 * Get the elapsed time from the start of the application at which the named item is ready
	 * @return the elapsed time in seconds
	 */
	 ...
	 */
	virtual bool registerAppCompleteCallback(IBootTimer::AppCompleteCallback cb) override ;

	/**
	 * Add a callback for tif complete
	 */
	virtual bool registerTifCompleteCallback(IBootTimer::TifCompleteCallback cb) override ;

	/**
	 * Add a callback for app complete
	 */
	virtual bool registerNamedCompleteCallback(const std::string& name, IBootTimer::NamedCompleteCallback cb) override ;
...
private:
	...
	std::map<std::string, std::vector<IBootTimer::NamedCompleteCallback>> mNamedCallbacks ;
} ;
