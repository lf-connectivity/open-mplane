...
public:
     ...
     */
	Frequency(long long unsigned int frequency, Frequency::Unit unit = Frequency::Hz);
...
inline std::ostream& operator << (std::ostream& os, const Mplane::Frequency& frequency)
{
	os << frequency.getUint(Mplane::Frequency::KHz) << " " << frequency.unit2Str( Mplane::Frequency::KHz) ;
	return os;
}
