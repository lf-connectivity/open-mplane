...
public:
    ...
    static const char* getState(ReturnType::State state)
    {
        switch (state)
        {
        case RT_OK:
...
/**
 * Create an attribute for any variable created for RAII. Add this attribute to stop compiler "unused" warnings
 *
@code
    Mplane::IPeripheralBus* RAII_VAR peripheral_bus( Mplane::IPeripheralBus::getInstance() ) ;
@endcode
 */
