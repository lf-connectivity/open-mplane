 ...
 *
 * The inheriting class just needs to provide the pure virtual methods operator== and operator< in order to have this
 * template provide all of the other operators.
 *
 * As an example:
 *
 * @code
 ...
 * 		virtual bool operator==(const Myclass& rhs) { return mData == rhs.mData; }
 *
...
public:
    ...
    /**
     * Comparison operator to allow an object value to be compared to see if it is less than
     * the value of another object. Must be overridden by derived object
     *
     * @param  rhs object reference
    ...
    /**
       * Comparison operator to allow an object value to be compared not equivalent to
       * another object.
       *
       * @code
       * Object f1=1000;
    ...
    /**
     * Comparison operator to allow an object value to be compared to see if it is greater than
    ...
    /**
     * Comparison operator to allow an object value to be compared to see if it is greater than or equal to
     * the value of another object.
     *
     * @code
     * Object f1=1000;
    ...
    /**
     * Comparison operator to allow an object value to be compared to see if it is less than or equal to
     * the value of another object.
     *
     * @code
     * Object f1=1000;
