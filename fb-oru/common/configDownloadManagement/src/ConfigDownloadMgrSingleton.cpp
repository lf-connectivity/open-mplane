...
//-------------------------------------------------------------------------------------------------------------
std::shared_ptr<IConfigDownloadManagement> IConfigDownloadManagement::getInstance()
{
	static std::shared_ptr<IConfigDownloadManagement> instance(new ConfigDownloadMgr()) ;
	static int start = std::dynamic_pointer_cast<ConfigDownloadManagement>(instance)->start() ;
