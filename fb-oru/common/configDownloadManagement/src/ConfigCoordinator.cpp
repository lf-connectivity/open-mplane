...
std::shared_ptr<IConfigCoordinator> IConfigCoordinator::singleton()
{
	static std::shared_ptr<IConfigCoordinator> instance = std::make_shared<ConfigCoordinator>();
...
//-------------------------------------------------------------------------------------------------------------
ReturnType::State ConfigCoordinator::registerConfig(std::shared_ptr<IConfigDownload> cfgDownload,
		std::shared_ptr<IConfigLoad> cfgData)
{
	...
	if (IConfigDownloadManagement::getInstance()->addConfigDownloadType(cfgDownload))
	{
...
//-------------------------------------------------------------------------------------------------------------
bool ConfigCoordinator::isConfigRegistered(std::string name)
{
...
//-------------------------------------------------------------------------------------------------------------
ReturnType::State ConfigCoordinator::load()
{
...
//-------------------------------------------------------------------------------------------------------------
ReturnType::State ConfigCoordinator::load(std::string name)
{
