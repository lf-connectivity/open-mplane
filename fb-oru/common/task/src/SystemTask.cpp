...
//-------------------------------------------------------------------------------------------------------------
int Mplane::SystemTask::runCmd(const std::string& cmd)
{
	bool timedOut ;
	return runCmd(cmd, [](unsigned){}, 0u, 0u, timedOut) ;
}

//-------------------------------------------------------------------------------------------------------------
int Mplane::SystemTask::runCmd(const std::string& cmd, unsigned timeoutSecs,
		bool& timedOut)
{
	return runCmd(cmd, [](unsigned){}, 0u, timeoutSecs, timedOut) ;
}
...
#ifdef DEBUG_SYSTEM_TASK
            std::cerr << "SystemTask - cmd complete status=" << mCmdStatus << std::endl ;
#endif
        }
    }
...
//-------------------------------------------------------------------------------------------------------------
int SystemTask::simpleSystem(const std::string& cmd)
{
    int status ;
