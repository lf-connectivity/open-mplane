...
FrequencyOffset::FrequencyOffset() :
	FrequencyBase<long long>()
{
}

//-------------------------------------------------------------------------------------------------------------
FrequencyOffset::FrequencyOffset(long long frequency, FrequencyOffset::Unit unit ) :
...
//-------------------------------------------------------------------------------------------------------------
long long FrequencyOffset::negativeValue(const long long val) const
{
	return val ;
}
