...
//-------------------------------------------------------------------------------------------------------------
bool Path::createLink(const std::string& link, std::string src)
{
...
//-------------------------------------------------------------------------------------------------------------
std::vector<std::string> Path::dirContents(const std::string& directory, bool chronologial)
{
...
//	size_t len = offsetof(struct dirent, d_name) + name_max + 1;
	...
	if (chronologial)
	{
		std::sort (contents.begin(), contents.end(), [](const std::string& lhs, const std::string& rhs){
...
//---------------------------------------------------------------------
bool Path::removeDirContents(const std::string& path, bool recursive)
{
...
//---------------------------------------------------------------------
std::string Path::name(const std::string &path)
{
	std::string base(basename(path)) ;
...
//---------------------------------------------------------------------
std::string Path::absolute(const std::string &path, const std::string &rootdir)
{
...
//---------------------------------------------------------------------
bool Path::filesDifferent(const std::string& filename1, const std::string& filename2, unsigned skipStart)
{
...
//---------------------------------------------------------------------
std::string Mplane::Path::clean(const std::string &path)
{
