...
public:
	 ...
	 */
	virtual bool enableFeature(IGenericFeature::GenericFeatureType features) override ;
	 ...
	 */
	virtual IGenericFeature::GenericFeatureType supportedFeatures() const override ;
...
private:
	void init() ;
	IGenericFeature::GenericFeatureType nameToFeature(const std::string& featureName) const ;
