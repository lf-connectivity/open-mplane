...
static const mode_t S_IRWXU = mode_t(_S_IREAD | _S_IWRITE);     ///< read/write/execute by user
static const mode_t S_IRWXG = mode_t(_S_IREAD | _S_IWRITE);     ///< read/write/execute by *USER*
...
public:
	...
	/**
	 * Read the link specified by mPath. If able to, sets 'link' to the mPath the link points to
	 * @param mPath
	...
	/**
	 * Create a link from 'link' to 'mPath'. 'mPath' is the full mPath to the link, 'link' is the contents of the
	 ...
	 * @param dest	File mPath or directory mPath. If directory, then copies file in with same name
	...
	/**
	 * Gets the amount of free space left on the file system that contains this directory mPath (or file mPath)
	 * @param mPath
