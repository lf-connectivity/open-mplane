...
public:
	 ...
	 */
	virtual bool processHeader(IWaveFile::WaveDataIter& dataStart, IWaveFile::WaveDataIter dataEnd) override ;
	 ...
	 * @return false on error
	 */
	bool createHeader(std::vector<uint8_t>& data, unsigned waveIndex, unsigned sampleRateKsps) ;
