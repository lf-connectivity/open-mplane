...
public:
	 ...
	 * @param dataStart	Iterator to start of data. Updated by this method as data is used
	 * @return false on error
	 */
	bool addData(IWaveFile::WaveDataIter& dataStart, IWaveFile::WaveDataIter dataEnd) ;
