 ...
 * Function:    calculate
 *
 * Description: Calculates the values at the query points using the cubic spline algorithm
 *
 * Returns:     The crc value (uint16)
 ************************************************************************************************************/
bool Mplane::cubicSpline::calculate(std::vector<double> xValues, std::vector<double> yValues,
		std::vector<double> queryPoints, std::vector<double> &interpolatedValues)
{
	  emxArray_real_T *yy;
	  emxArray_real_T *x;
	  emxArray_real_T *y;
