...
namespace {
	...
	// Replace any characters in the string that are also in the string charsToReplace with the specified replacement character
...
//-------------------------------------------------------------------------------------------------------------
int PathUtils::mkdir(const std::string& _path, mode_t mode)
{
#ifdef _MSC_VER
...
*/
int PathUtils::mkpath(const std::string& _path, mode_t mode)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
#else
...
//-------------------------------------------------------------------------------------------------------------
int PathUtils::rmdir(const std::string& _path)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
#else
...
//-------------------------------------------------------------------------------------------------------------
int PathUtils::remove(const std::string& _path)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
#else
...
//-------------------------------------------------------------------------------------------------------------
int PathUtils::move(const std::string& _oldpath, const std::string& _newpath)
{
#ifdef _MSC_VER
...
//-------------------------------------------------------------------------------------------------------------
bool PathUtils::isDir(const std::string& _path)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
#else
...
//-------------------------------------------------------------------------------------------------------------
bool PathUtils::isFile(const std::string& _path)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
...
//-------------------------------------------------------------------------------------------------------------
bool PathUtils::isLink(const std::string& path)
{
#ifdef _MSC_VER
#else
	// check that it's a file
...
//-------------------------------------------------------------------------------------------------------------
bool PathUtils::readLink(const std::string& path, std::string& link)
{
#ifdef _MSC_VER
	return false;
#else
...
//-------------------------------------------------------------------------------------------------------------
bool PathUtils::createLink(const std::string& path, std::string link)
{
#ifdef _MSC_VER
#else
...
//-------------------------------------------------------------------------------------------------------------
std::vector<std::string> PathUtils::dirContents(const std::string& _directory)
{
#ifdef _MSC_VER
...
//-------------------------------------------------------------------------------------------------------------
bool PathUtils::exists(const std::string& _path)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
#else
...
//-------------------------------------------------------------------------------------------------------------
std::string PathUtils::basename(const std::string& _path)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
#else
...
//-------------------------------------------------------------------------------------------------------------
std::string PathUtils::dir(const std::string& _path)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
#else
...
//-------------------------------------------------------------------------------------------------------------
std::string PathUtils::join(const std::string& _dir, const std::string& _basename)
{
#ifdef _MSC_VER
...
//-------------------------------------------------------------------------------------------------------------
bool PathUtils::fileCopy(const std::string& _src, const std::string& _dst)
{
#ifdef _MSC_VER
...
//-------------------------------------------------------------------------------------------------------------
unsigned PathUtils::fileSize(const std::string& _path)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
#else
...
//
unsigned long long PathUtils::freeSpace(const std::string& path)
{
#ifdef _MSC_VER
	return 0ULL ;
#else
...
//---------------------------------------------------------------------
bool PathUtils::removeDirContents(const std::string& _path, bool recursive)
{
#ifdef _MSC_VER
	const std::string path(sanitisePath(_path));
#else
...
//---------------------------------------------------------------------
bool PathUtils::filesDifferent(const std::string& _filename1, const std::string& _filename2, unsigned skipStart)
{
#ifdef _MSC_VER
...
//---------------------------------------------------------------------
std::string PathUtils::sanitisePath(const std::string& path)
{
