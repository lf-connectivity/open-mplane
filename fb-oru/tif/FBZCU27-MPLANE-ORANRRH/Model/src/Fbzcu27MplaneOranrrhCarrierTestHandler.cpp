 ...
 *
 * \file      Fbzcu27MplaneOranrrhCarrierTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/carrier", "Carrier settings functions", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhCarrierTestHandler("/carrier/del",
			"INT Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhCarrierTestHandler("/carrier/get",
			"INT Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhCarrierTestHandler("/carrier/getRssi",
			"INT Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhCarrierTestHandler("/carrier/set",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhCarrierTestHandler("/carrier/show",
			"INT Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhCarrierTestHandler("/carrier/showAll",
			"",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27MplaneOranrrhCarrierTestHandler::Fbzcu27MplaneOranrrhCarrierTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27MplaneOranrrhCarrierTestHandler::Fbzcu27MplaneOranrrhCarrierTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Fbzcu27MplaneOranrrhCarrierTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Fbzcu27MplaneOranrrhCarrierTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::del(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::get(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::getRssi(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::set(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// * [ENUM(${CARRIER_TYPES}) Type]
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::show(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::showAll(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::NumCarriersGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::RxPathsGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhCarrierTestHandler::TxPathsGet(  const std::string& pathname, DataVariantList *returnList )
{
