 ...
 *
 * \file      Fbzcu27MplaneOranrrhHeartbeatTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/heartbeat", "Heartbeat Monitor", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhHeartbeatTestHandler("/heartbeat/getEnable",
			"",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhHeartbeatTestHandler("/heartbeat/getState",
			"",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhHeartbeatTestHandler("/heartbeat/getTimeout",
			"",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhHeartbeatTestHandler("/heartbeat/ping",
			"",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhHeartbeatTestHandler("/heartbeat/setEnable",
			"BOOL(OFF:ON) enable",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
			"Set the enable",
			msgParser, settings))
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhHeartbeatTestHandler("/heartbeat/setTimeout",
			"INT timeout (s)",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27MplaneOranrrhHeartbeatTestHandler::Fbzcu27MplaneOranrrhHeartbeatTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27MplaneOranrrhHeartbeatTestHandler::Fbzcu27MplaneOranrrhHeartbeatTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Fbzcu27MplaneOranrrhHeartbeatTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Fbzcu27MplaneOranrrhHeartbeatTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::getEnable(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::getState(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::getTimeout(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::ping(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::setEnable(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * BOOL(OFF:ON) enable
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::setTimeout(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT timeout (s)
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
bool Fbzcu27MplaneOranrrhHeartbeatTestHandler::enableSet(  const std::string& pathname, DataVariant *value, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::enableGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
bool Fbzcu27MplaneOranrrhHeartbeatTestHandler::timeoutSet(  const std::string& pathname, DataVariant *value, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::timeoutGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhHeartbeatTestHandler::stateGet(  const std::string& pathname, DataVariantList *returnList )
{
