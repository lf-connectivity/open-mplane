 ...
 *
 * \file      Fbzcu27MplaneOranrrhYangManagerTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhYangManagerTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/oran/yang-mgr", "YANG manager test methods", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhYangManagerTestHandler("/oran/yang-mgr/getInstalledModuleList",
			"",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhYangManagerTestHandler("/oran/yang-mgr/getModuleFeatures",
			"STRING module",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhYangManagerTestHandler("/oran/yang-mgr/getStatus",
			"",
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27MplaneOranrrhYangManagerTestHandler::Fbzcu27MplaneOranrrhYangManagerTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27MplaneOranrrhYangManagerTestHandler::Fbzcu27MplaneOranrrhYangManagerTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Fbzcu27MplaneOranrrhYangManagerTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Fbzcu27MplaneOranrrhYangManagerTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhYangManagerTestHandler::getInstalledModuleList(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhYangManagerTestHandler::getModuleFeatures(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * STRING module
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhYangManagerTestHandler::getStatus(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
