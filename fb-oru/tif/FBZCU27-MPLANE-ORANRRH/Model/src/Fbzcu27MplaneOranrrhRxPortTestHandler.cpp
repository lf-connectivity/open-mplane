 ...
 *
 * \file      Fbzcu27MplaneOranrrhRxPortTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/rx", "Rx Port settings", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/getAdcRms",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/getExtFilterLoss",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/getFreq",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/getIfAtten",
			"INT{1..${NUM_RX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dB)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/getPath",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/getRfAtten",
			"INT{1..${NUM_RX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dB)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/getRssi",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/getTemp",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/setEnable",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/setExtFilterLoss",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/setFreq",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/setIfAtten",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/setPath",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/setRfAtten",
			"INT{1..${NUM_RX_PORTS}} index,FLOAT value (dB)",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27MplaneOranrrhRxPortTestHandler("/rx/showSynth",
			"INT{1..${NUM_RX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27MplaneOranrrhRxPortTestHandler::Fbzcu27MplaneOranrrhRxPortTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27MplaneOranrrhRxPortTestHandler::Fbzcu27MplaneOranrrhRxPortTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Fbzcu27MplaneOranrrhRxPortTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Fbzcu27MplaneOranrrhRxPortTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::getAdcRms(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::getExtFilterLoss(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::getFreq(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::getIfAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::getPath(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::getRfAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::getRssi(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::getTemp(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::setEnable(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::setExtFilterLoss(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::setFreq(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// * FLOAT value (kHz)
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::setIfAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// * FLOAT value (dB)
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::setPath(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// * INT path
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::setRfAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// * FLOAT value (dB)
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::showSynth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27MplaneOranrrhRxPortTestHandler::PortsGet(  const std::string& pathname, DataVariantList *returnList )
{
	// Getter for "/rx/Ports"
	//
