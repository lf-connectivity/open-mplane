 ...
 *
 * \file      Fbzcu27MplaneOranrrhNetopeerMonTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHNETOPEERMONTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHNETOPEERMONTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhNetopeerMonTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhNetopeerMonTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhNetopeerMonTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhNetopeerMonTestHandler();
...
private:
	std::shared_ptr<NetopeerMonTestHelper> mHelper ;
};
...
#endif /* __FBZCU27MPLANEORANRRHNETOPEERMONTESTHANDLER__H_*/
