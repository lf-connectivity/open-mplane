 ...
 *
 * \file      Fbzcu27MplaneOranrrhYangConfigTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHYANGCONFIGTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHYANGCONFIGTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhYangConfigTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhYangConfigTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhYangConfigTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhYangConfigTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHYANGCONFIGTESTHANDLER__H_*/
