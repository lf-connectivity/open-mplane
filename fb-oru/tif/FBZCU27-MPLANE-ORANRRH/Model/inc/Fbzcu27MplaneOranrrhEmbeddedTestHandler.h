 ...
 *
 * \file      Fbzcu27MplaneOranrrhEmbeddedTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHEMBEDDEDTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHEMBEDDEDTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhEmbeddedTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhEmbeddedTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhEmbeddedTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhEmbeddedTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHEMBEDDEDTESTHANDLER__H_*/
