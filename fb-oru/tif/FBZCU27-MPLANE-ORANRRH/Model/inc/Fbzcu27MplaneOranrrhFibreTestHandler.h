 ...
 *
 * \file      Fbzcu27MplaneOranrrhFibreTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHFIBRETESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHFIBRETESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhFibreTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhFibreTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhFibreTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhFibreTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHFIBRETESTHANDLER__H_*/
