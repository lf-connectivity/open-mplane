 ...
 *
 * \file      Fbzcu27MplaneOranrrhRadioStateTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHRADIOSTATETESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHRADIOSTATETESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhRadioStateTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhRadioStateTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhRadioStateTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhRadioStateTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHRADIOSTATETESTHANDLER__H_*/
