 ...
 *
 * \file      Fbzcu27MplaneOranrrhAgcTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHAGCTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHAGCTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhAgcTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhAgcTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhAgcTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhAgcTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHAGCTESTHANDLER__H_*/
