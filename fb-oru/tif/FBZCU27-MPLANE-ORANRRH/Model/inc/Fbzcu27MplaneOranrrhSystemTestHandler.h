 ...
 *
 * \file      Fbzcu27MplaneOranrrhSystemTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHSYSTEMTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHSYSTEMTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhSystemTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhSystemTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhSystemTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhSystemTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHSYSTEMTESTHANDLER__H_*/
