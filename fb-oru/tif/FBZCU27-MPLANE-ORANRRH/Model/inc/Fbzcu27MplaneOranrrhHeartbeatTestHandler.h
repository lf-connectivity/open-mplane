 ...
 *
 * \file      Fbzcu27MplaneOranrrhHeartbeatTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHHEARTBEATTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHHEARTBEATTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhHeartbeatTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhHeartbeatTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhHeartbeatTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhHeartbeatTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHHEARTBEATTESTHANDLER__H_*/
