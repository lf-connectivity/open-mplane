 ...
 *
 * \file      Fbzcu27MplaneOranrrhCarrierTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHCARRIERTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHCARRIERTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhCarrierTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhCarrierTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhCarrierTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhCarrierTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHCARRIERTESTHANDLER__H_*/
