 ...
 *
 * \file      Fbzcu27MplaneOranrrhYangTestTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHYANGTESTTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHYANGTESTTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhYangTestTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhYangTestTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhYangTestTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhYangTestTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHYANGTESTTESTHANDLER__H_*/
