 ...
 *
 * \file      Fbzcu27MplaneOranrrhI2cTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHI2CTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHI2CTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhI2cTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhI2cTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhI2cTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhI2cTestHandler();
...
protected:
	 ...
	 *
	 */
	void writeShort( DataVariantList *callList, DataVariantList *returnList );
...
#endif /* __FBZCU27MPLANEORANRRHI2CTESTHANDLER__H_*/
