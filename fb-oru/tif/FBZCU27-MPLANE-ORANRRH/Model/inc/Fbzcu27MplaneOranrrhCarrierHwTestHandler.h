 ...
 *
 * \file      Fbzcu27MplaneOranrrhCarrierHwTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHCARRIERHWTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHCARRIERHWTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhCarrierHwTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhCarrierHwTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhCarrierHwTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhCarrierHwTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHCARRIERHWTESTHANDLER__H_*/
