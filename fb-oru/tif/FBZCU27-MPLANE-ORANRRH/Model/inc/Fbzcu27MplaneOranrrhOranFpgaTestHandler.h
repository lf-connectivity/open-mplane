 ...
 *
 * \file      Fbzcu27MplaneOranrrhOranFpgaTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHORANFPGATESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHORANFPGATESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhOranFpgaTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhOranFpgaTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhOranFpgaTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhOranFpgaTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHORANFPGATESTHANDLER__H_*/
