 ...
 *
 * \file      Fbzcu27MplaneOranrrhTxPortTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHTXPORTTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHTXPORTTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhTxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhTxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhTxPortTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhTxPortTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHTXPORTTESTHANDLER__H_*/
