 ...
 *
 * \file      Fbzcu27MplaneOranrrhSrxPortTestHandler.h
...
#ifndef __FBZCU27MPLANEORANRRHSRXPORTTESTHANDLER__H_
#define __FBZCU27MPLANEORANRRHSRXPORTTESTHANDLER__H_
...
class Fbzcu27MplaneOranrrhSrxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27MplaneOranrrhSrxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27MplaneOranrrhSrxPortTestHandler();
	 ...
	 */
	Fbzcu27MplaneOranrrhSrxPortTestHandler();
...
#endif /* __FBZCU27MPLANEORANRRHSRXPORTTESTHANDLER__H_*/
