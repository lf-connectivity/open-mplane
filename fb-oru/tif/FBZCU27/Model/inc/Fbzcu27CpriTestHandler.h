...
#ifndef __FBZCU27CPRITESTHANDLER__H_
#define __FBZCU27CPRITESTHANDLER__H_
...
class Fbzcu27CpriTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Fbzcu27CpriTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Fbzcu27CpriTestHandler();
...
#endif /* __FBZCU27CPRITESTHANDLER__H_*/
