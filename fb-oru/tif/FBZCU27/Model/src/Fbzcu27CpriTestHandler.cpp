 ...
 *
 * \file      Fbzcu27CpriTestHandler.cpp
 * \brief     Test methods for Fbzcu27
 *
 *
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/cpri", "CPRI Interface functions", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/get",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/getRxBitWidth",
			"INT{0..${MAX_FIBRE}} Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/getTxBitWidth",
			"INT{0..${MAX_FIBRE}} Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],INT bitwidth",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/getWaitSamples",
			"INT{0..${MAX_FIBRE}} Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/reset",
			"INT{0..${MAX_FIBRE}} Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/restart",
			"INT{0..${MAX_FIBRE}} Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/set",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/setRate",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/setRxBitWidth",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/setTxBitWidth",
			"INT{0..${MAX_FIBRE}} Index,INT{12..16} bitwidth",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/setWaitSamples",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/showAll",
			"",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/showCtl",
			"",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Fbzcu27CpriTestHandler("/cpri/showPort",
			"INT{0..${MAX_FIBRE}} Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27CpriTestHandler::Fbzcu27CpriTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Fbzcu27CpriTestHandler::Fbzcu27CpriTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Fbzcu27CpriTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Fbzcu27CpriTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::get(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::getRxBitWidth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::getTxBitWidth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::getWaitSamples(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::reset(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::restart(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::set(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::setRate(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::setRxBitWidth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// * INT{12..16} bitwidth
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::setTxBitWidth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// * INT{12..16} bitwidth
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::setWaitSamples(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::showAll(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::showCtl(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::showPort(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Fbzcu27CpriTestHandler::NumPortsGet(  const std::string& pathname, DataVariantList *returnList )
{
