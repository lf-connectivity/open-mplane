 ...
 *
 * \file      Zcu111MplaneOranrrhDot1agdMonTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHDOT1AGDMONTESTHANDLER__H_
#define __ZCU111MPLANEORANRRHDOT1AGDMONTESTHANDLER__H_
...
class Zcu111MplaneOranrrhDot1agdMonTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhDot1agdMonTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhDot1agdMonTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhDot1agdMonTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHDOT1AGDMONTESTHANDLER__H_*/
