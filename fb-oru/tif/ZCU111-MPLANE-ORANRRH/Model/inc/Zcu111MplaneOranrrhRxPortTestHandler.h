 ...
 *
 * \file      Zcu111MplaneOranrrhRxPortTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHRXPORTTESTHANDLER__H_
#define __ZCU111MPLANEORANRRHRXPORTTESTHANDLER__H_
...
class Zcu111MplaneOranrrhRxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhRxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhRxPortTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhRxPortTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHRXPORTTESTHANDLER__H_*/
