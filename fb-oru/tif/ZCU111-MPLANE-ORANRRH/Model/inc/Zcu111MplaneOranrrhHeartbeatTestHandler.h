 ...
 *
 * \file      Zcu111MplaneOranrrhHeartbeatTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHHEARTBEATTESTHANDLER__H_
#define __ZCU111MPLANEORANRRHHEARTBEATTESTHANDLER__H_
...
class Zcu111MplaneOranrrhHeartbeatTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhHeartbeatTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhHeartbeatTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhHeartbeatTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHHEARTBEATTESTHANDLER__H_*/
