 ...
 *
 * \file      Zcu111MplaneOranrrhSrxPortTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHSRXPORTTESTHANDLER__H_
#define __ZCU111MPLANEORANRRHSRXPORTTESTHANDLER__H_
...
class Zcu111MplaneOranrrhSrxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhSrxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhSrxPortTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhSrxPortTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHSRXPORTTESTHANDLER__H_*/
