 ...
 *
 * \file      Zcu111MplaneOranrrhAgcTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHAGCTESTHANDLER__H_
#define __ZCU111MPLANEORANRRHAGCTESTHANDLER__H_
...
class Zcu111MplaneOranrrhAgcTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhAgcTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhAgcTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhAgcTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHAGCTESTHANDLER__H_*/
