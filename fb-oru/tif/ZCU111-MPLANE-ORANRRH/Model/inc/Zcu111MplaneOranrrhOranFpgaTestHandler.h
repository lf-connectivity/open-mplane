 ...
 *
 * \file      Zcu111MplaneOranrrhOranFpgaTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHORANFPGATESTHANDLER__H_
#define __ZCU111MPLANEORANRRHORANFPGATESTHANDLER__H_
...
class Zcu111MplaneOranrrhOranFpgaTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhOranFpgaTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhOranFpgaTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhOranFpgaTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHORANFPGATESTHANDLER__H_*/
