 ...
 *
 * \file      Zcu111MplaneOranrrhI2cTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHI2CTESTHANDLER__H_
#define __ZCU111MPLANEORANRRHI2CTESTHANDLER__H_
...
class Zcu111MplaneOranrrhI2cTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhI2cTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhI2cTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhI2cTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHI2CTESTHANDLER__H_*/
