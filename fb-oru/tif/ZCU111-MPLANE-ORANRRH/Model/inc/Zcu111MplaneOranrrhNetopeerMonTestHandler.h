 ...
 *
 * \file      Zcu111MplaneOranrrhNetopeerMonTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHNETOPEERMONTESTHANDLER__H_
#define __ZCU111MPLANEORANRRHNETOPEERMONTESTHANDLER__H_
...
class Zcu111MplaneOranrrhNetopeerMonTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhNetopeerMonTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhNetopeerMonTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhNetopeerMonTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHNETOPEERMONTESTHANDLER__H_*/
