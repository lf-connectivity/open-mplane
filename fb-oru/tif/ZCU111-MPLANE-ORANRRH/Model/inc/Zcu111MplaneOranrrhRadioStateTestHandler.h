 ...
 *
 * \file      Zcu111MplaneOranrrhRadioStateTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHRADIOSTATETESTHANDLER__H_
#define __ZCU111MPLANEORANRRHRADIOSTATETESTHANDLER__H_
...
class Zcu111MplaneOranrrhRadioStateTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhRadioStateTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhRadioStateTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhRadioStateTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHRADIOSTATETESTHANDLER__H_*/
