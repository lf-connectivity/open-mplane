 ...
 *
 * \file      Zcu111MplaneOranrrhCarrierTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHCARRIERTESTHANDLER__H_
#define __ZCU111MPLANEORANRRHCARRIERTESTHANDLER__H_
...
class Zcu111MplaneOranrrhCarrierTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhCarrierTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhCarrierTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhCarrierTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHCARRIERTESTHANDLER__H_*/
