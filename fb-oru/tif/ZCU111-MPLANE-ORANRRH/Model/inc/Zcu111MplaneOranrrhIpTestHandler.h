 ...
 *
 * \file      Zcu111MplaneOranrrhIpTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHIPTESTHANDLER__H_
#define __ZCU111MPLANEORANRRHIPTESTHANDLER__H_
...
class Zcu111MplaneOranrrhIpTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhIpTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhIpTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhIpTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHIPTESTHANDLER__H_*/
