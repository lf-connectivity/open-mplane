 ...
 *
 * \file      Zcu111MplaneOranrrhFpgaTestHandler.h
...
#ifndef __ZCU111MPLANEORANRRHFPGATESTHANDLER__H_
#define __ZCU111MPLANEORANRRHFPGATESTHANDLER__H_
...
class Zcu111MplaneOranrrhFpgaTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111MplaneOranrrhFpgaTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111MplaneOranrrhFpgaTestHandler();
	 ...
	 */
	Zcu111MplaneOranrrhFpgaTestHandler();
...
#endif /* __ZCU111MPLANEORANRRHFPGATESTHANDLER__H_*/
