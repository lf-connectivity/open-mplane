 ...
 *
 * \file      Zcu111MplaneOranrrhYangConfigTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/oran/yangConfig", "Yang Configuration", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhYangConfigTestHandler("/oran/yangConfig/getSupportedModules",
			"",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhYangConfigTestHandler("/oran/yangConfig/listConfigTree",
			"",
...
//-------------------------------------------------------------------------------------------------------------
Zcu111MplaneOranrrhYangConfigTestHandler::Zcu111MplaneOranrrhYangConfigTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Zcu111MplaneOranrrhYangConfigTestHandler::Zcu111MplaneOranrrhYangConfigTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Zcu111MplaneOranrrhYangConfigTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Zcu111MplaneOranrrhYangConfigTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::getSupportedModules(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::listConfigTree(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::CompanyNameGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::ConfigStatusGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::FormatVersionGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::ORANversionGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::ProductNameGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::VariantNameGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhYangConfigTestHandler::YANGversionGet(  const std::string& pathname, DataVariantList *returnList )
{
