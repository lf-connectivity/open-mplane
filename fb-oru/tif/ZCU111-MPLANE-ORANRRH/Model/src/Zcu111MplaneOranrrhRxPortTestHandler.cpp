 ...
 *
 * \file      Zcu111MplaneOranrrhRxPortTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/rx", "Rx Port settings", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/getAdcRms",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/getExtFilterLoss",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/getFreq",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/getIfAtten",
			"INT{1..${NUM_RX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dB)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/getPath",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/getRfAtten",
			"INT{1..${NUM_RX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dB)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/getRssi",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/getTemp",
			"INT{1..${NUM_RX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/setEnable",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/setExtFilterLoss",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/setFreq",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/setIfAtten",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/setPath",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/setRfAtten",
			"INT{1..${NUM_RX_PORTS}} index,FLOAT value (dB)",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111MplaneOranrrhRxPortTestHandler("/rx/showSynth",
			"INT{1..${NUM_RX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
Zcu111MplaneOranrrhRxPortTestHandler::Zcu111MplaneOranrrhRxPortTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Zcu111MplaneOranrrhRxPortTestHandler::Zcu111MplaneOranrrhRxPortTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Zcu111MplaneOranrrhRxPortTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Zcu111MplaneOranrrhRxPortTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::getAdcRms(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::getExtFilterLoss(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::getFreq(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::getIfAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::getPath(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::getRfAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::getRssi(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::getTemp(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::setEnable(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::setExtFilterLoss(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::setFreq(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// * FLOAT value (kHz)
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::setIfAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// * FLOAT value (dB)
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::setPath(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// * INT path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::setRfAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// * FLOAT value (dB)
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::showSynth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_RX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111MplaneOranrrhRxPortTestHandler::PortsGet(  const std::string& pathname, DataVariantList *returnList )
{
	// Getter for "/rx/Ports"
	//
