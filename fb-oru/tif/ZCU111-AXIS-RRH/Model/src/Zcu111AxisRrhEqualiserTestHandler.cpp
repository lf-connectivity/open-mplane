 ...
 *
 * \file      Zcu111AxisRrhEqualiserTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhEqualiserTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/equaliser", "Equaliser settings", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhEqualiserTestHandler("/equaliser/getPassthrough",
			"",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhEqualiserTestHandler("/equaliser/setPassthrough",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhEqualiserTestHandler("/equaliser/showAll",
			"",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhEqualiserTestHandler("/equaliser/showRx",
			"INT Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhEqualiserTestHandler("/equaliser/showTx",
			"INT Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
Zcu111AxisRrhEqualiserTestHandler::Zcu111AxisRrhEqualiserTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Zcu111AxisRrhEqualiserTestHandler::Zcu111AxisRrhEqualiserTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Zcu111AxisRrhEqualiserTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Zcu111AxisRrhEqualiserTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhEqualiserTestHandler::getPassthrough(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhEqualiserTestHandler::setPassthrough(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * BOOL(OFF:ON) passthrough
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhEqualiserTestHandler::showAll(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhEqualiserTestHandler::showRx(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhEqualiserTestHandler::showTx(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
