 ...
 *
 * \file      Zcu111AxisRrhSrxPortTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/srx", "SRx Port settings", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getAdcRms",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getAtten",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getCorrection",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getFreq",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getFwdPathAdcRms",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getFwdPathCorrection",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getFwdPathPower",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getFwdTssi",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getPath",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getPower",
			"INT{1..${NUM_SRX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getRevPathAdcRms",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBfs)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getRevPathCorrection",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getRevPathPower",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getRevTssi",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT tssiResult (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/getTemp",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/setAtten",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/setDirection",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/setFreq",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/setPath",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisRrhSrxPortTestHandler("/srx/showSynth",
			"INT{1..${NUM_SRX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
Zcu111AxisRrhSrxPortTestHandler::Zcu111AxisRrhSrxPortTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Zcu111AxisRrhSrxPortTestHandler::Zcu111AxisRrhSrxPortTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Zcu111AxisRrhSrxPortTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Zcu111AxisRrhSrxPortTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getAdcRms(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getCorrection(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getFreq(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getFwdPathAdcRms(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getFwdPathCorrection(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getFwdPathPower(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getFwdTssi(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getPath(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getPower(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getRevPathAdcRms(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getRevPathCorrection(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getRevPathPower(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getRevTssi(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::getTemp(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::setAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * FLOAT value (dB)
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::setDirection(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::setFreq(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * FLOAT value (kHz)
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::setPath(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} channel
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::showSynth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisRrhSrxPortTestHandler::PortsGet(  const std::string& pathname, DataVariantList *returnList )
{
