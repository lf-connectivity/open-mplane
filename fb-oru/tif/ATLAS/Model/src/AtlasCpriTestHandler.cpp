 ...
 *
 * \file      AtlasCpriTestHandler.cpp
 * \brief     Test methods for Atlas
 *
 *
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/cpri", "CPRI Interface functions", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/get",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/getRxBitWidth",
			"INT{0..${MAX_FIBRE}} Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/getTxBitWidth",
			"INT{0..${MAX_FIBRE}} Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],INT bitwidth",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/getWaitSamples",
			"INT{0..${MAX_FIBRE}} Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/reset",
			"INT{0..${MAX_FIBRE}} Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/restart",
			"INT{0..${MAX_FIBRE}} Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/set",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/setRate",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/setRxBitWidth",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/setTxBitWidth",
			"INT{0..${MAX_FIBRE}} Index,INT{12..16} bitwidth",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/setWaitSamples",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/showAll",
			"",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/showCtl",
			"",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasCpriTestHandler("/cpri/showPort",
			"INT{0..${MAX_FIBRE}} Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
AtlasCpriTestHandler::AtlasCpriTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
AtlasCpriTestHandler::AtlasCpriTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool AtlasCpriTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string AtlasCpriTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::get(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::getRxBitWidth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::getTxBitWidth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::getWaitSamples(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::reset(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::restart(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::set(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::setRate(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::setRxBitWidth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// * INT{12..16} bitwidth
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::setTxBitWidth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// * INT{12..16} bitwidth
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::setWaitSamples(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::showAll(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::showCtl(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::showPort(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{0..${MAX_FIBRE}} Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasCpriTestHandler::NumPortsGet(  const std::string& pathname, DataVariantList *returnList )
{
