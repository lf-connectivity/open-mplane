...
#ifndef __ATLASCPRITESTHANDLER__H_
#define __ATLASCPRITESTHANDLER__H_
...
class AtlasCpriTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasCpriTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasCpriTestHandler();
...
#endif /* __ATLASCPRITESTHANDLER__H_*/
