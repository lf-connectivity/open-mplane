 ...
 *
 * \file      CommonModelImagesFpgaTestHandler.h
...
#ifndef __COMMONMODELIMAGESFPGATESTHANDLER__H_
#define __COMMONMODELIMAGESFPGATESTHANDLER__H_
...
class CommonModelImagesFpgaTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	CommonModelImagesFpgaTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~CommonModelImagesFpgaTestHandler();
	 ...
	 */
	CommonModelImagesFpgaTestHandler();
...
private:
	std::shared_ptr<ImagesFpgaTestHelper> mHelper ;
};
...
#endif /* __COMMONMODELIMAGESFPGATESTHANDLER__H_*/
