 ...
 *
 * \file      CommonModelImagesOsTestHandler.h
...
#ifndef __COMMONMODELIMAGESOSTESTHANDLER__H_
#define __COMMONMODELIMAGESOSTESTHANDLER__H_
...
class CommonModelImagesOsTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	CommonModelImagesOsTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~CommonModelImagesOsTestHandler();
	 ...
	 */
	CommonModelImagesOsTestHandler();
...
#endif /* __COMMONMODELIMAGESOSTESTHANDLER__H_*/
