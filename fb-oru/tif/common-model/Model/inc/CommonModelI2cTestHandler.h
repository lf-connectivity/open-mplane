 ...
 *
 * \file      CommonModelI2cTestHandler.h
...
#ifndef __COMMONMODELI2CTESTHANDLER__H_
#define __COMMONMODELI2CTESTHANDLER__H_
...
class CommonModelI2cTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	CommonModelI2cTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~CommonModelI2cTestHandler();
...
#endif /* __COMMONMODELI2CTESTHANDLER__H_*/
