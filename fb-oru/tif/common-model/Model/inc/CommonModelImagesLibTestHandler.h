 ...
 *
 * \file      CommonModelImagesLibTestHandler.h
...
#ifndef __COMMONMODELIMAGESLIBTESTHANDLER__H_
#define __COMMONMODELIMAGESLIBTESTHANDLER__H_
...
class CommonModelImagesLibTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	CommonModelImagesLibTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~CommonModelImagesLibTestHandler();
	 ...
	 */
	CommonModelImagesLibTestHandler();
...
#endif /* __COMMONMODELIMAGESLIBTESTHANDLER__H_*/
