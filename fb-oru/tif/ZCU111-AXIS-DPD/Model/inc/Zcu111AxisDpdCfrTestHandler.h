 ...
 *
 * \file      Zcu111AxisDpdCfrTestHandler.h
...
#ifndef __ZCU111AXISDPDCFRTESTHANDLER__H_
#define __ZCU111AXISDPDCFRTESTHANDLER__H_
...
class Zcu111AxisDpdCfrTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111AxisDpdCfrTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111AxisDpdCfrTestHandler();
...
protected:
	 ...
	 *
	 */
	void setThresholds( DataVariantList *callList, DataVariantList *returnList );
	 ...
	 *
	 */
	void showThresholds( DataVariantList *callList, DataVariantList *returnList );
...
private:
	std::shared_ptr<CfrTestHelper> mHelper ;
};
...
#endif /* __ZCU111AXISDPDCFRTESTHANDLER__H_*/
