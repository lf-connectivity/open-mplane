 ...
 *
 * \file      Zcu111AxisDpdSrxPortTestHandler.h
...
#ifndef __ZCU111AXISDPDSRXPORTTESTHANDLER__H_
#define __ZCU111AXISDPDSRXPORTTESTHANDLER__H_
...
class Zcu111AxisDpdSrxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111AxisDpdSrxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111AxisDpdSrxPortTestHandler();
	 ...
	 */
	Zcu111AxisDpdSrxPortTestHandler();
...
#endif /* __ZCU111AXISDPDSRXPORTTESTHANDLER__H_*/
