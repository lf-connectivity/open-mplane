 ...
 *
 * \file      Zcu111AxisDpdDpdCtrlTestHandler.h
...
#ifndef __ZCU111AXISDPDDPDCTRLTESTHANDLER__H_
#define __ZCU111AXISDPDDPDCTRLTESTHANDLER__H_
...
class Zcu111AxisDpdDpdCtrlTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111AxisDpdDpdCtrlTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111AxisDpdDpdCtrlTestHandler();
	 ...
	 */
	Zcu111AxisDpdDpdCtrlTestHandler();
...
private:
	std::shared_ptr<DpdCtrlTestHelper> mHelper ;
};
...
#endif /* __ZCU111AXISDPDDPDCTRLTESTHANDLER__H_*/
