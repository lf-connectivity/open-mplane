 ...
 *
 * \file      Zcu111AxisDpdSrxPortTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/srx", "SRx Port settings", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getAdcRms",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getAtten",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getCorrection",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getFreq",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getFwdPathAdcRms",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getFwdPathCorrection",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getFwdPathPower",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getFwdTssi",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getPath",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getPower",
			"INT{1..${NUM_SRX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getRevPathAdcRms",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBfs)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getRevPathCorrection",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getRevPathPower",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT value (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getRevTssi",
			"INT{1..${NUM_SRX_PORTS}} index,INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message],FLOAT tssiResult (dBm)",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/getTemp",
			"INT{1..${NUM_SRX_PORTS}} index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/setAtten",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/setDirection",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/setFreq",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/setPath",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111AxisDpdSrxPortTestHandler("/srx/showSynth",
			"INT{1..${NUM_SRX_PORTS}} index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
Zcu111AxisDpdSrxPortTestHandler::Zcu111AxisDpdSrxPortTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Zcu111AxisDpdSrxPortTestHandler::Zcu111AxisDpdSrxPortTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Zcu111AxisDpdSrxPortTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Zcu111AxisDpdSrxPortTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getAdcRms(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getCorrection(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getFreq(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getFwdPathAdcRms(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getFwdPathCorrection(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getFwdPathPower(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getFwdTssi(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getPath(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getPower(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getRevPathAdcRms(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getRevPathCorrection(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getRevPathPower(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getRevTssi(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} path
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::getTemp(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::setAtten(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * FLOAT value (dB)
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::setDirection(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::setFreq(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * FLOAT value (kHz)
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::setPath(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// * INT{1..${NUM_TX_PORTS_PER_SRX_PORT}} channel
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::showSynth(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT{1..${NUM_SRX_PORTS}} index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111AxisDpdSrxPortTestHandler::PortsGet(  const std::string& pathname, DataVariantList *returnList )
{
