 ...
 *
 * \file      AtlasMplaneOranrrhSystemTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhSystemTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/system", "System information", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new AtlasMplaneOranrrhSystemTestHandler("/system/setClockIn",
...
//-------------------------------------------------------------------------------------------------------------
AtlasMplaneOranrrhSystemTestHandler::AtlasMplaneOranrrhSystemTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
AtlasMplaneOranrrhSystemTestHandler::AtlasMplaneOranrrhSystemTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool AtlasMplaneOranrrhSystemTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string AtlasMplaneOranrrhSystemTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhSystemTestHandler::setClockIn(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * ENUM(INTERNAL:External_10MHz:FIBRE:10G_SYNCE:25G_SYNCE) clkin
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhSystemTestHandler::ClockInGet(  const std::string& pathname, DataVariantList *returnList )
{
