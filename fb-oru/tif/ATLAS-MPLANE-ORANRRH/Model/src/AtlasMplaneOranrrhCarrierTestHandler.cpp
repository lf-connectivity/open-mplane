 ...
 *
 * \file      AtlasMplaneOranrrhCarrierTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/carrier", "Carrier settings functions", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new AtlasMplaneOranrrhCarrierTestHandler("/carrier/del",
			"INT Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasMplaneOranrrhCarrierTestHandler("/carrier/get",
			"INT Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasMplaneOranrrhCarrierTestHandler("/carrier/getRssi",
			"INT Index",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasMplaneOranrrhCarrierTestHandler("/carrier/set",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasMplaneOranrrhCarrierTestHandler("/carrier/show",
			"INT Index",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new AtlasMplaneOranrrhCarrierTestHandler("/carrier/showAll",
			"",
			"ENUM(OK:ERROR) Status=OK,[STRING Info],[STRING Message]",
...
//-------------------------------------------------------------------------------------------------------------
AtlasMplaneOranrrhCarrierTestHandler::AtlasMplaneOranrrhCarrierTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
AtlasMplaneOranrrhCarrierTestHandler::AtlasMplaneOranrrhCarrierTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool AtlasMplaneOranrrhCarrierTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string AtlasMplaneOranrrhCarrierTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::del(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::get(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::getRssi(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::set(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// * [ENUM(${CARRIER_TYPES}) Type]
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::show(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * INT Index
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::showAll(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::NumCarriersGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::RxPathsGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void AtlasMplaneOranrrhCarrierTestHandler::TxPathsGet(  const std::string& pathname, DataVariantList *returnList )
{
