 ...
 *
 * \file      AtlasMplaneOranrrhSystemConfigTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHSYSTEMCONFIGTESTHANDLER__H_
#define __ATLASMPLANEORANRRHSYSTEMCONFIGTESTHANDLER__H_
...
class AtlasMplaneOranrrhSystemConfigTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhSystemConfigTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhSystemConfigTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhSystemConfigTestHandler();
...
#endif /* __ATLASMPLANEORANRRHSYSTEMCONFIGTESTHANDLER__H_*/
