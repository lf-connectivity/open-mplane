 ...
 *
 * \file      AtlasMplaneOranrrhYangTestTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHYANGTESTTESTHANDLER__H_
#define __ATLASMPLANEORANRRHYANGTESTTESTHANDLER__H_
...
class AtlasMplaneOranrrhYangTestTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhYangTestTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhYangTestTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhYangTestTestHandler();
...
#endif /* __ATLASMPLANEORANRRHYANGTESTTESTHANDLER__H_*/
