 ...
 *
 * \file      AtlasMplaneOranrrhAgcTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHAGCTESTHANDLER__H_
#define __ATLASMPLANEORANRRHAGCTESTHANDLER__H_
...
class AtlasMplaneOranrrhAgcTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhAgcTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhAgcTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhAgcTestHandler();
...
#endif /* __ATLASMPLANEORANRRHAGCTESTHANDLER__H_*/
