 ...
 *
 * \file      AtlasMplaneOranrrhYangConfigTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHYANGCONFIGTESTHANDLER__H_
#define __ATLASMPLANEORANRRHYANGCONFIGTESTHANDLER__H_
...
class AtlasMplaneOranrrhYangConfigTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhYangConfigTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhYangConfigTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhYangConfigTestHandler();
...
#endif /* __ATLASMPLANEORANRRHYANGCONFIGTESTHANDLER__H_*/
