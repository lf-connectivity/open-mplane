 ...
 *
 * \file      AtlasMplaneOranrrhNetopeerMonTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHNETOPEERMONTESTHANDLER__H_
#define __ATLASMPLANEORANRRHNETOPEERMONTESTHANDLER__H_
...
class AtlasMplaneOranrrhNetopeerMonTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhNetopeerMonTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhNetopeerMonTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhNetopeerMonTestHandler();
...
#endif /* __ATLASMPLANEORANRRHNETOPEERMONTESTHANDLER__H_*/
