 ...
 *
 * \file      AtlasMplaneOranrrhRxPortTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHRXPORTTESTHANDLER__H_
#define __ATLASMPLANEORANRRHRXPORTTESTHANDLER__H_
...
class AtlasMplaneOranrrhRxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhRxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhRxPortTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhRxPortTestHandler();
...
#endif /* __ATLASMPLANEORANRRHRXPORTTESTHANDLER__H_*/
