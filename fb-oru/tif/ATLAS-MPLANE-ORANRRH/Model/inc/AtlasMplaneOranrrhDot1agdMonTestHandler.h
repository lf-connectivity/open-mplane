 ...
 *
 * \file      AtlasMplaneOranrrhDot1agdMonTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHDOT1AGDMONTESTHANDLER__H_
#define __ATLASMPLANEORANRRHDOT1AGDMONTESTHANDLER__H_
...
class AtlasMplaneOranrrhDot1agdMonTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhDot1agdMonTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhDot1agdMonTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhDot1agdMonTestHandler();
...
#endif /* __ATLASMPLANEORANRRHDOT1AGDMONTESTHANDLER__H_*/
