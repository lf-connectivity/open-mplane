 ...
 *
 * \file      AtlasMplaneOranrrhOranFpgaTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHORANFPGATESTHANDLER__H_
#define __ATLASMPLANEORANRRHORANFPGATESTHANDLER__H_
...
class AtlasMplaneOranrrhOranFpgaTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhOranFpgaTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhOranFpgaTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhOranFpgaTestHandler();
...
#endif /* __ATLASMPLANEORANRRHORANFPGATESTHANDLER__H_*/
