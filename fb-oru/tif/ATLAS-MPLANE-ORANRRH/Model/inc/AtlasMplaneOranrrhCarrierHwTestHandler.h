 ...
 *
 * \file      AtlasMplaneOranrrhCarrierHwTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHCARRIERHWTESTHANDLER__H_
#define __ATLASMPLANEORANRRHCARRIERHWTESTHANDLER__H_
...
class AtlasMplaneOranrrhCarrierHwTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhCarrierHwTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhCarrierHwTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhCarrierHwTestHandler();
...
#endif /* __ATLASMPLANEORANRRHCARRIERHWTESTHANDLER__H_*/
