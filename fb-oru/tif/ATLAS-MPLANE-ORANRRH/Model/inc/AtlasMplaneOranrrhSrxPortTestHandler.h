 ...
 *
 * \file      AtlasMplaneOranrrhSrxPortTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHSRXPORTTESTHANDLER__H_
#define __ATLASMPLANEORANRRHSRXPORTTESTHANDLER__H_
...
class AtlasMplaneOranrrhSrxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhSrxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhSrxPortTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhSrxPortTestHandler();
...
#endif /* __ATLASMPLANEORANRRHSRXPORTTESTHANDLER__H_*/
