 ...
 *
 * \file      AtlasMplaneOranrrhEmbeddedTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHEMBEDDEDTESTHANDLER__H_
#define __ATLASMPLANEORANRRHEMBEDDEDTESTHANDLER__H_
...
class AtlasMplaneOranrrhEmbeddedTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhEmbeddedTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhEmbeddedTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhEmbeddedTestHandler();
...
#endif /* __ATLASMPLANEORANRRHEMBEDDEDTESTHANDLER__H_*/
