 ...
 *
 * \file      AtlasMplaneOranrrhTxPortTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHTXPORTTESTHANDLER__H_
#define __ATLASMPLANEORANRRHTXPORTTESTHANDLER__H_
...
class AtlasMplaneOranrrhTxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhTxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhTxPortTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhTxPortTestHandler();
...
#endif /* __ATLASMPLANEORANRRHTXPORTTESTHANDLER__H_*/
