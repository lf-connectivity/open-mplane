 ...
 *
 * \file      AtlasMplaneOranrrhHeartbeatTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHHEARTBEATTESTHANDLER__H_
#define __ATLASMPLANEORANRRHHEARTBEATTESTHANDLER__H_
...
class AtlasMplaneOranrrhHeartbeatTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhHeartbeatTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhHeartbeatTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhHeartbeatTestHandler();
...
#endif /* __ATLASMPLANEORANRRHHEARTBEATTESTHANDLER__H_*/
