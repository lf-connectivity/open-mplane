 ...
 *
 * \file      AtlasMplaneOranrrhCarrierTestHandler.h
...
#ifndef __ATLASMPLANEORANRRHCARRIERTESTHANDLER__H_
#define __ATLASMPLANEORANRRHCARRIERTESTHANDLER__H_
...
class AtlasMplaneOranrrhCarrierTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	AtlasMplaneOranrrhCarrierTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~AtlasMplaneOranrrhCarrierTestHandler();
	 ...
	 */
	AtlasMplaneOranrrhCarrierTestHandler();
...
#endif /* __ATLASMPLANEORANRRHCARRIERTESTHANDLER__H_*/
