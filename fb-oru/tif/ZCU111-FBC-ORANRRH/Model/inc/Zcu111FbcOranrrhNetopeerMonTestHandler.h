 ...
 *
 * \file      Zcu111FbcOranrrhNetopeerMonTestHandler.h
...
#ifndef __ZCU111FBCORANRRHNETOPEERMONTESTHANDLER__H_
#define __ZCU111FBCORANRRHNETOPEERMONTESTHANDLER__H_
...
class Zcu111FbcOranrrhNetopeerMonTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhNetopeerMonTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhNetopeerMonTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhNetopeerMonTestHandler();
...
#endif /* __ZCU111FBCORANRRHNETOPEERMONTESTHANDLER__H_*/
