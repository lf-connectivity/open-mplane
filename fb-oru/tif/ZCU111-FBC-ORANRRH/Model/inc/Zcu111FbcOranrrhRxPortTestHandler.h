 ...
 *
 * \file      Zcu111FbcOranrrhRxPortTestHandler.h
...
#ifndef __ZCU111FBCORANRRHRXPORTTESTHANDLER__H_
#define __ZCU111FBCORANRRHRXPORTTESTHANDLER__H_
...
class Zcu111FbcOranrrhRxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhRxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhRxPortTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhRxPortTestHandler();
...
#endif /* __ZCU111FBCORANRRHRXPORTTESTHANDLER__H_*/
