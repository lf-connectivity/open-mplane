 ...
 *
 * \file      Zcu111FbcOranrrhYangTestTestHandler.h
...
#ifndef __ZCU111FBCORANRRHYANGTESTTESTHANDLER__H_
#define __ZCU111FBCORANRRHYANGTESTTESTHANDLER__H_
...
class Zcu111FbcOranrrhYangTestTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhYangTestTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhYangTestTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhYangTestTestHandler();
...
#endif /* __ZCU111FBCORANRRHYANGTESTTESTHANDLER__H_*/
