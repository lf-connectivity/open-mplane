 ...
 *
 * \file      Zcu111FbcOranrrhFpgaTestHandler.h
...
#ifndef __ZCU111FBCORANRRHFPGATESTHANDLER__H_
#define __ZCU111FBCORANRRHFPGATESTHANDLER__H_
...
class Zcu111FbcOranrrhFpgaTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhFpgaTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhFpgaTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhFpgaTestHandler();
...
#endif /* __ZCU111FBCORANRRHFPGATESTHANDLER__H_*/
