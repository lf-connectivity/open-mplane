 ...
 *
 * \file      Zcu111FbcOranrrhEmbeddedTestHandler.h
...
#ifndef __ZCU111FBCORANRRHEMBEDDEDTESTHANDLER__H_
#define __ZCU111FBCORANRRHEMBEDDEDTESTHANDLER__H_
...
class Zcu111FbcOranrrhEmbeddedTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhEmbeddedTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhEmbeddedTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhEmbeddedTestHandler();
...
#endif /* __ZCU111FBCORANRRHEMBEDDEDTESTHANDLER__H_*/
