 ...
 *
 * \file      Zcu111FbcOranrrhI2cTestHandler.h
...
#ifndef __ZCU111FBCORANRRHI2CTESTHANDLER__H_
#define __ZCU111FBCORANRRHI2CTESTHANDLER__H_
...
class Zcu111FbcOranrrhI2cTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhI2cTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhI2cTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhI2cTestHandler();
...
#endif /* __ZCU111FBCORANRRHI2CTESTHANDLER__H_*/
