 ...
 *
 * \file      Zcu111FbcOranrrhSystemConfigTestHandler.h
...
#ifndef __ZCU111FBCORANRRHSYSTEMCONFIGTESTHANDLER__H_
#define __ZCU111FBCORANRRHSYSTEMCONFIGTESTHANDLER__H_
...
class Zcu111FbcOranrrhSystemConfigTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhSystemConfigTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhSystemConfigTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhSystemConfigTestHandler();
...
#endif /* __ZCU111FBCORANRRHSYSTEMCONFIGTESTHANDLER__H_*/
