 ...
 *
 * \file      Zcu111FbcOranrrhSrxPortTestHandler.h
...
#ifndef __ZCU111FBCORANRRHSRXPORTTESTHANDLER__H_
#define __ZCU111FBCORANRRHSRXPORTTESTHANDLER__H_
...
class Zcu111FbcOranrrhSrxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhSrxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhSrxPortTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhSrxPortTestHandler();
...
#endif /* __ZCU111FBCORANRRHSRXPORTTESTHANDLER__H_*/
