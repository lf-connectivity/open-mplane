 ...
 *
 * \file      Zcu111FbcOranrrhYangConfigTestHandler.h
...
#ifndef __ZCU111FBCORANRRHYANGCONFIGTESTHANDLER__H_
#define __ZCU111FBCORANRRHYANGCONFIGTESTHANDLER__H_
...
class Zcu111FbcOranrrhYangConfigTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhYangConfigTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhYangConfigTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhYangConfigTestHandler();
...
#endif /* __ZCU111FBCORANRRHYANGCONFIGTESTHANDLER__H_*/
