 ...
 *
 * \file      Zcu111FbcOranrrhFibreTestHandler.h
...
#ifndef __ZCU111FBCORANRRHFIBRETESTHANDLER__H_
#define __ZCU111FBCORANRRHFIBRETESTHANDLER__H_
...
class Zcu111FbcOranrrhFibreTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhFibreTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhFibreTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhFibreTestHandler();
...
#endif /* __ZCU111FBCORANRRHFIBRETESTHANDLER__H_*/
