 ...
 *
 * \file      Zcu111FbcOranrrhIpTestHandler.h
...
#ifndef __ZCU111FBCORANRRHIPTESTHANDLER__H_
#define __ZCU111FBCORANRRHIPTESTHANDLER__H_
...
class Zcu111FbcOranrrhIpTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhIpTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhIpTestHandler();
...
#endif /* __ZCU111FBCORANRRHIPTESTHANDLER__H_*/
