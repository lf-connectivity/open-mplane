 ...
 *
 * \file      Zcu111FbcOranrrhTxPortTestHandler.h
...
#ifndef __ZCU111FBCORANRRHTXPORTTESTHANDLER__H_
#define __ZCU111FBCORANRRHTXPORTTESTHANDLER__H_
...
class Zcu111FbcOranrrhTxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	Zcu111FbcOranrrhTxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~Zcu111FbcOranrrhTxPortTestHandler();
	 ...
	 */
	Zcu111FbcOranrrhTxPortTestHandler();
...
#endif /* __ZCU111FBCORANRRHTXPORTTESTHANDLER__H_*/
