 ...
 *
 * \file      Zcu111FbcOranrrhYangManagerTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111FbcOranrrhYangManagerTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/oran/yang-mgr", "YANG manager test methods", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111FbcOranrrhYangManagerTestHandler("/oran/yang-mgr/getInstalledModuleList",
			"",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111FbcOranrrhYangManagerTestHandler("/oran/yang-mgr/getModuleFeatures",
			"STRING module",
	...
	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111FbcOranrrhYangManagerTestHandler("/oran/yang-mgr/getStatus",
			"",
...
//-------------------------------------------------------------------------------------------------------------
Zcu111FbcOranrrhYangManagerTestHandler::Zcu111FbcOranrrhYangManagerTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Zcu111FbcOranrrhYangManagerTestHandler::Zcu111FbcOranrrhYangManagerTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Zcu111FbcOranrrhYangManagerTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Zcu111FbcOranrrhYangManagerTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111FbcOranrrhYangManagerTestHandler::getInstalledModuleList(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111FbcOranrrhYangManagerTestHandler::getModuleFeatures(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * STRING module
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111FbcOranrrhYangManagerTestHandler::getStatus(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// *
	// Returns:
