 ...
 *
 * \file      Zcu111FbcOranrrhSystemTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111FbcOranrrhSystemTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
	// Create a directory to store the data in
	msgParser.addDir( new DirClass("/system", "System information", msgParser, settings) ) ;


	msgParser.add( static_cast<RtiDirEntry *>(new Zcu111FbcOranrrhSystemTestHandler("/system/setClockIn",
...
//-------------------------------------------------------------------------------------------------------------
Zcu111FbcOranrrhSystemTestHandler::Zcu111FbcOranrrhSystemTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
Zcu111FbcOranrrhSystemTestHandler::Zcu111FbcOranrrhSystemTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool Zcu111FbcOranrrhSystemTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string Zcu111FbcOranrrhSystemTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111FbcOranrrhSystemTestHandler::setClockIn(  DataVariantList *callList, DataVariantList *returnList )
{
	// Called with:
	// * ENUM(INTERNAL:External_10MHz:FIBRE:10G_SYNCE:25G_SYNCE) clkin
	// Returns:
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111FbcOranrrhSystemTestHandler::ClockInGet(  const std::string& pathname, DataVariantList *returnList )
{
