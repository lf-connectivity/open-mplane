...
#ifndef __HELPERARBTESTHANDLER__H_
#define __HELPERARBTESTHANDLER__H_
...
class HelperArbTestHandler: public EntryFunc
{
public:

	HelperArbTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~HelperArbTestHandler();
...
private:
	std::shared_ptr<ArbTestHelper> mHelper ;
};
...
#endif /* __HELPERARBTESTHANDLER__H_*/
