 ...
 *
 * \file      HelperImagesFpgaTestHandler.h
...
#ifndef __HELPERIMAGESFPGATESTHANDLER__H_
#define __HELPERIMAGESFPGATESTHANDLER__H_
...
class HelperImagesFpgaTestHandler: public EntryFunc
{
public:

	HelperImagesFpgaTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~HelperImagesFpgaTestHandler();
...
#endif /* __HELPERIMAGESFPGATESTHANDLER__H_*/
