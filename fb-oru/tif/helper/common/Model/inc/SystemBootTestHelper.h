...
#ifndef __SYSTEMBOOTTESTHELPER__H_
#define __SYSTEMBOOTTESTHELPER__H_
...
public:
	...
	// singleton
	static std::shared_ptr<SystemBootTestHelper> getInstance() ;


	SystemBootTestHelper();

    virtual ~SystemBootTestHelper();
...
#endif /* __SYSTEMBOOTTESTHELPER__H_*/
