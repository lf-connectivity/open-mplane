...
#ifndef __IMAGESLIBTESTHELPER__H_
#define __IMAGESLIBTESTHELPER__H_
...
public:
	...
	// singleton
	static std::shared_ptr<ImagesLibTestHelper> getInstance() ;


	ImagesLibTestHelper();

    virtual ~ImagesLibTestHelper();
...
#endif /* __IMAGESLIBTESTHELPER__H_*/
