...
#ifndef __IMAGESFPGATESTHELPER__H_
#define __IMAGESFPGATESTHELPER__H_
...
public:
	...
	// singleton
	static std::shared_ptr<ImagesFpgaTestHelper> getInstance() ;


	ImagesFpgaTestHelper();

    virtual ~ImagesFpgaTestHelper();
...
#endif /* __IMAGESFPGATESTHELPER__H_*/
