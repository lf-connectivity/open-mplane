...
#ifndef __ARBPLAYBACKTESTHELPER__H_
#define __ARBPLAYBACKTESTHELPER__H_
...
public:
	...
	// singleton
	static std::shared_ptr<ArbPlaybackTestHelper> getInstance() ;


	ArbPlaybackTestHelper();

    virtual ~ArbPlaybackTestHelper();
	 ...
	 *
	 */
	void multicast( IRtiMsgParser& msgParser, DataVariantList *callList, DataVariantList *returnList );
...
#endif /* __ARBPLAYBACKTESTHELPER__H_*/
