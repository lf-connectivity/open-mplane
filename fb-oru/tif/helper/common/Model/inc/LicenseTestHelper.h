...
#ifndef __LICENSETESTHELPER__H_
#define __LICENSETESTHELPER__H_
...
public:
	...
	// singleton
	static std::shared_ptr<LicenseTestHelper> getInstance() ;


	LicenseTestHelper();

    virtual ~LicenseTestHelper();
