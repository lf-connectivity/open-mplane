 ...
 *
 * \file      OranrrhYangTestTestHandler.h
...
#ifndef __ORANRRHYANGTESTTESTHANDLER__H_
#define __ORANRRHYANGTESTTESTHANDLER__H_
...
class OranrrhYangTestTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	OranrrhYangTestTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~OranrrhYangTestTestHandler();
...
#endif /* __ORANRRHYANGTESTTESTHANDLER__H_*/
