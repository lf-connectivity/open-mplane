 ...
 *
 * \file      CommonRxPortTestHandler.h
...
#ifndef __COMMONRXPORTTESTHANDLER__H_
#define __COMMONRXPORTTESTHANDLER__H_
...
class CommonRxPortTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	CommonRxPortTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~CommonRxPortTestHandler();
...
protected:
	 ...
	 *
	 */
	void setAutoAttenMode( DataVariantList *callList, DataVariantList *returnList );
	 ...
	 *
	 */
	void setManAttenMode( DataVariantList *callList, DataVariantList *returnList );
...
#endif /* __COMMONRXPORTTESTHANDLER__H_*/
