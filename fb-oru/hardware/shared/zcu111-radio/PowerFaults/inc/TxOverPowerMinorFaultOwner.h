 ...
 *
 * \file      TxOverpowerMinorFaultOwner.h
 * \brief
 *
 *
 * \details
...
#ifndef TX_OVERPOWER_MINOR_FAULTOWNER_H_
#define TX_OVERPOWER_MINOR_FAULTOWNER_H_
...
class TxOverPowerMinorFaultOwner : public FaultOwner,
//								   public Loggable,
								   public Observer<ITxOn, const ITxEventData&>,
								   public Observer<ITxOff, const ITxEventData&>
{
public:
	TxOverPowerMinorFaultOwner() ;
	virtual ~TxOverPowerMinorFaultOwner() ;
    ...
    {
        return "TX_OVERPOWER_MINOR_FAULT_OWNER";
    }
...
#endif /* TX_OVERPOWER_MINOR_FAULTOWNER_H_ */
