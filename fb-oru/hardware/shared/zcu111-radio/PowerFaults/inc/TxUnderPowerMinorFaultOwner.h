 ...
 *
 * \file      TxUnderpowerMinorFaultOwner.h
 * \brief
 *
 *
 * \details
...
#ifndef TX_UNDERPOWER_MINOR_FAULTOWNER_H_
#define TX_UNDERPOWER_MINOR_FAULTOWNER_H_
...
class TxUnderPowerMinorFaultOwner : public FaultOwner,
									public Observer<ITxOn, const ITxEventData&>,
									public Observer<ITxOff, const ITxEventData&>
{
public:
	TxUnderPowerMinorFaultOwner() ;
	virtual ~TxUnderPowerMinorFaultOwner() ;
    ...
    {
        return "TX_UNDERPOWER_MINOR_FAULT_OWNER";
    }
...
#endif /* TX_UNDERPOWER_MINOR_FAULTOWNER_H_ */
