...
#ifndef FpgaCommsMSGMATLAB_H_
#define FpgaCommsMSGMATLAB_H_

#include "FpgaCommsMsgBase.h"

namespace Mplane {

class FpgaCommsMsgMatlab : public FpgaCommsMsgBase
{
public:
	/**
	 ...
	 * @param pdu
	 */
	FpgaCommsMsgMatlab(std::shared_ptr<IFpgaMsgTokens> tokens, std::shared_ptr<IFpgaPdu> pdu) ;
	 ...
	 * @param pdu
	 */
	FpgaCommsMsgMatlab(std::shared_ptr<IFpgaMsgTokens> tokens, const IFpgaPdu& pdu) ;

	/**
	 * Destructor
	 */
	virtual ~FpgaCommsMsgMatlab() ;
...
private:
	 ...
	 *
	 */
	FpgaCommsMsgMatlab(std::shared_ptr<IFpgaMsgTokens> tokens,
