 ...
 *
 * \file      RemoteCommsMsgCmd.h
 * \brief     A RemoteCommsMsg specifically handling RESPONSE types
 *
 *
 * \details
 *
...
class RemoteCommsMsgCmd : public RemoteCommsMsgBase
{
public:
	/**
	 ...
	 *
	 */
	RemoteCommsMsgCmd(std::shared_ptr<IFpgaMsgTokens> tokens,
	 ...
	 * @param pdu
	 */
	RemoteCommsMsgCmd(std::shared_ptr<IFpgaMsgTokens> tokens, std::shared_ptr<IFpgaPdu> pdu) ;
	 ...
	 * @param pdu
	 */
	RemoteCommsMsgCmd(std::shared_ptr<IFpgaMsgTokens> tokens, const IFpgaPdu& pdu) ;

	/**
	 * Destructor
	 */
	virtual ~RemoteCommsMsgCmd() ;
