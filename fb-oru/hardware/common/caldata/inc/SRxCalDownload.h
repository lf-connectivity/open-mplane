...
#ifndef SRXCALDOWNLOAD_H_
#define SRXCALDOWNLOAD_H_

#include "CalDownload.h"

namespace Mplane {

class SRxCalDownload : public CalDownload
{
public:
	using super = CalDownload ;

	SRxCalDownload() ;
	virtual ~SRxCalDownload() ;
