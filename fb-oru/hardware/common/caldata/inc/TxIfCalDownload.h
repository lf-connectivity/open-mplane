 ...
 *
 * \file      TxIfCalDownload.h
 * \brief     TX IF cal file download
 *
 *
 * \details
 *
...
#ifndef TXIFCALDOWNLOAD_H_
#define TXIFCALDOWNLOAD_H_

#include "CalDownload.h"

namespace Mplane {

class TxIfCalDownload : public CalDownload
{
public:
	using super = CalDownload ;

	TxIfCalDownload() ;
	virtual ~TxIfCalDownload() ;
