 ...
 *
 * \file      DelayUnitUI.h
 * \brief     Provide support for dsp clock units / 128
 *
 *
 * \details
 *
...
#ifndef DELAYUNITCLK128_H_
#define DELAYUNITCLK128_H_

#include "DelayUnit/DelayUnit.h"

namespace Mplane {

class DelayUnitCLK128 : public DelayUnit
{
public:
	static const DelayUnitCLK128 UNIT ;
