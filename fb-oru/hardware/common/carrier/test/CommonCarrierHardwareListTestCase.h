#ifndef _MPLANE_COMMONCARRIERHWLISTTESTCASE_H_
#define _MPLANE_COMMONCARRIERHWLISTTESTCASE_H_
 ...
 */
class CommonCarrierHardwareListTestCase : public CPPUNIT_NS::TestFixture
{
    /*!
     * Macro definitions used to add the test definitions to the base test fixture
     */
    CPPUNIT_TEST_SUITE( CommonCarrierHardwareListTestCase );
    CPPUNIT_TEST( unittest );
    CPPUNIT_TEST( foreach_test );
...
#endif /* _MPLANE_COMMONCARRIERHWLISTTESTCASE_H_ */
