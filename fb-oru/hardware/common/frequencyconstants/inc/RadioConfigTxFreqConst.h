#ifndef _RADIOCONFIGTXFREQUENCYCONSTANT_H_
#define _RADIOCONFIGTXFREQUENCYCONSTANT_H_
 ...
 *
 * \file      RadioConfigTxFreqConst.h
 * \brief     Get the TX frequency constants from the IRadioConfig singleton
 *
 *
 * \details   Get the TX frequency constants from the IRadioConfig singleton
 *
 */
 ...
 */
class RadioConfigTxFreqConst: public ITxFrequencyConst
{
public:
...
protected:
    RadioConfigTxFreqConst();

    /**
     * Destructor
     */
    virtual ~RadioConfigTxFreqConst();
...
#endif /* _RADIOCONFIGTXFREQUENCYCONSTANT_H_ */
