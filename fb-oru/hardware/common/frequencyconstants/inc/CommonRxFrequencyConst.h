#ifndef _COMMONRXFREQUENCYCONSTANT_H_
#define _COMMONRXFREQUENCYCONSTANT_H_
 ...
 */
class CommonRxFrequencyConst: public IRxFrequencyConst
{
public:
...
#endif /* _COMMONRXFREQUENCYCONSTANT_H_ */
