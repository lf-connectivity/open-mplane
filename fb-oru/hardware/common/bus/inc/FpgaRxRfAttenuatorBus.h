...
#ifndef COMMON_BUS_INC_FPGARXRFATTNBUS_H_
#define COMMON_BUS_INC_FPGARXRFATTNBUS_H_
 ...
 *
 */
class FpgaRxRfAttenuatorBus : public SpiBus {
public:

	FpgaRxRfAttenuatorBus(const std::string& busName, const std::string& busDetails, std::shared_ptr<IBusLock> busLock,
			std::shared_ptr<ISpiBusReadonlySettings> busSettings, unsigned index) ;
	virtual ~FpgaRxRfAttenuatorBus() ;
...
#endif /* COMMON_BUS_INC_FPGARXRFATTNBUS_H_ */
