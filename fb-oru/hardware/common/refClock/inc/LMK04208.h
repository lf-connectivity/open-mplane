 ...
 *
 * \file      LMK04208.h
 * \brief     Low-noise clock jitter cleaner with dual loop PLLs
 *
 *
...
#ifndef COMMON_SPI_INC_LMK04208_H_
#define COMMON_SPI_INC_LMK04208_H_
...
/*!
 * \class  LMK04208 driver class
 * \brief
 * \details
 *
 */
class LMK04208 : public virtual IRefClockDriver, public RegDriver
{
public:
	LMK04208(std::shared_ptr<ISpiBus> spi, const std::string& name) ;
	virtual ~LMK04208() ;
...
#endif /* COMMON_SPI_INC_LMK04208_H_ */
