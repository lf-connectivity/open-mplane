 ...
 *
 * \file      DpdXilinxDpdTestHandler.h
...
#ifndef __DPDXILINXDPDTESTHANDLER__H_
#define __DPDXILINXDPDTESTHANDLER__H_
...
class DpdXilinxDpdTestHandler: public virtual ITifEntry, public EntryFunc
{
public:

	DpdXilinxDpdTestHandler( const std::string& pathname, const std::string& comment,
    		const std::string& callFields, const std::string& returnFields,
    		IRtiMsgParser& msgParser, IRtiSettings& settings);

    virtual ~DpdXilinxDpdTestHandler();
...
#endif /* __DPDXILINXDPDTESTHANDLER__H_*/
