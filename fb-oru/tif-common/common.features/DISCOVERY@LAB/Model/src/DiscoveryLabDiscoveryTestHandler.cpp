 ...
 *
 * \file      DiscoveryLabDiscoveryTestHandler.cpp
...
//-------------------------------------------------------------------------------------------------------------
void DiscoveryLabDiscoveryTestHandler::registerMethods(IRtiMsgParser& msgParser, IRtiSettings& settings)
{
...
//-------------------------------------------------------------------------------------------------------------
DiscoveryLabDiscoveryTestHandler::DiscoveryLabDiscoveryTestHandler() :
...
//-------------------------------------------------------------------------------------------------------------
DiscoveryLabDiscoveryTestHandler::DiscoveryLabDiscoveryTestHandler(const std::string& pathname, const std::string& callFields,
...
//-------------------------------------------------------------------------------------------------------------
bool DiscoveryLabDiscoveryTestHandler::registerEntry(ITif* tif)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string DiscoveryLabDiscoveryTestHandler::operator()(const std::string& functionName)
{
...
//-------------------------------------------------------------------------------------------------------------
void DiscoveryLabDiscoveryTestHandler::cacheAgeGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void DiscoveryLabDiscoveryTestHandler::ipGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void DiscoveryLabDiscoveryTestHandler::notifyCountGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void DiscoveryLabDiscoveryTestHandler::searchCountGet(  const std::string& pathname, DataVariantList *returnList )
{
...
//-------------------------------------------------------------------------------------------------------------
void DiscoveryLabDiscoveryTestHandler::uuidGet(  const std::string& pathname, DataVariantList *returnList )
{
