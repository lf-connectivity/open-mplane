...
namespace {
	...
	template <class T>
	T typeConvert(std::shared_ptr<YangParam> param, std::string &error)
	{
		error.clear() ;
...
//-------------------------------------------------------------------------------------------------------------
unsigned YangParamUtils::toUnsigned(std::shared_ptr<YangParam> param, std::string &error)
{
	return toUint32(param, error) ;
}

//-------------------------------------------------------------------------------------------------------------
int YangParamUtils::toInt(std::shared_ptr<YangParam> param, std::string &error)
{
	return toInt32(param, error) ;
}

//-------------------------------------------------------------------------------------------------------------
uint64_t YangParamUtils::toUint64(std::shared_ptr<YangParam> param, std::string &error)
{
	uint64_t val(0) ;
...
//-------------------------------------------------------------------------------------------------------------
int64_t YangParamUtils::toInt64(std::shared_ptr<YangParam> param, std::string &error)
{
	return typeConvert<int64_t>(param, error) ;
}

//-------------------------------------------------------------------------------------------------------------
uint32_t YangParamUtils::toUint32(std::shared_ptr<YangParam> param, std::string &error)
{
	return typeConvert<uint32_t>(param, error) ;
}

//-------------------------------------------------------------------------------------------------------------
int32_t YangParamUtils::toInt32(std::shared_ptr<YangParam> param, std::string &error)
{
	return typeConvert<int32_t>(param, error) ;
}

//-------------------------------------------------------------------------------------------------------------
uint16_t YangParamUtils::toUint16(std::shared_ptr<YangParam> param, std::string &error)
{
	return typeConvert<uint16_t>(param, error) ;
}

//-------------------------------------------------------------------------------------------------------------
int16_t YangParamUtils::toInt16(std::shared_ptr<YangParam> param, std::string &error)
{
	return typeConvert<int16_t>(param, error) ;
}

//-------------------------------------------------------------------------------------------------------------
uint8_t YangParamUtils::toUint8(std::shared_ptr<YangParam> param, std::string &error)
{
	return typeConvert<uint8_t>(param, error) ;
}

//-------------------------------------------------------------------------------------------------------------
int8_t YangParamUtils::toInt8(std::shared_ptr<YangParam> param, std::string &error)
{
	return typeConvert<int8_t>(param, error) ;
}

//-------------------------------------------------------------------------------------------------------------
bool YangParamUtils::toBool(std::shared_ptr<YangParam> param, std::string &error)
{
	error.clear() ;
...
//-------------------------------------------------------------------------------------------------------------
std::string YangParamUtils::toString(std::shared_ptr<YangParam> param, std::string &error)
{
	switch(param->getType())
	{
	case YangParamType_E::BOOL:
...
//-------------------------------------------------------------------------------------------------------------
std::shared_ptr<YangParam> YangParamUtils::find(std::shared_ptr<YangParams> params, const std::string &xpath)
{
...
//-------------------------------------------------------------------------------------------------------------
void YangParamUtils::show(std::shared_ptr<YangParams> params)
{
	for (unsigned i=0; i < params->getNumParams(); ++i)
	{
		std::shared_ptr<YangParam> p(params->getParam(i)) ;
