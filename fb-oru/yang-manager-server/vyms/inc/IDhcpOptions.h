...
public:
	 ...
	 */
	using DhcpOptionsNotifyFunc = std::function<void(const std::string& interface)> ;
	 ...
	 */
	virtual bool getServerIdentifier(std::string interface, std::string& serverId) = 0;
	 ...
	 */
	virtual bool getDefaultGateways(std::string interface, std::vector<std::string>& gateways) = 0;

	/*
	 * Method to get the netconf clients
	 */
	virtual bool getNetConfClients(std::string interface, std::map<std::string, std::string>& clients) = 0;

	/*
	 * Method to get the vendor specific information
	 */
	virtual bool getVendorSpecificInfo(std::string interface, std::map<unsigned int, std::vector<std::string>>& vendorSpecificInfo) = 0;
