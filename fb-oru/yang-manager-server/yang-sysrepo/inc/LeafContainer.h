...
public:
	 ...
	 */
	virtual std::shared_ptr<ILeafContainer> getNamed(const std::string& name, bool recursive = true) const override ;

	/**
	 * Delete the named node from this container. If "recursive" is true then decends any containers looking for the named node.
	 */
	virtual void deleteNamed(const std::string& name, bool recursive = true) override ;
	 ...
	 */
	virtual void removeContainer(std::shared_ptr<ILeafContainer> component) override;

	/**
	 * Add a container element to this container's contents
	 */
	virtual std::shared_ptr<ILeafContainer> addContainer(const std::string& name) override ;

	/**
	 * Add a container (list) element to this container's contents
	 */
	virtual std::shared_ptr<ILeafContainer> addContainerList(const std::string& name) override ;

	/**
	 * Add a container (choice) element to this container's contents
	 */
	virtual std::shared_ptr<ILeafContainer> addContainerChoice(const std::string& name) override ;
	 ...
	 */
	virtual void addLeaf(const std::string& leafName, ILeafContainer::LeafFunc func) override ;

	/**
	 * Add a leaf value to this container's contents
	 */
	virtual void addLeaf(const std::string& leafName, const std::string& leafValue) override ;

	/**
	 * Add a leaf unsigned value as hex to this container's contents
	 */
	virtual void addLeafHex(const std::string& leafName, unsigned leafValue) override ;
	 ...
	 * Add a leaf value to this container's contents
	 */
	virtual void addLeafUInt64(const std::string& leafName, uint64_t leafValue) override ;

	/**
	 * Add a leaf value to this container's contents
	 */
	virtual void addLeafUInt32(const std::string& leafName, uint32_t leafValue) override ;

	/**
	 * Add a leaf value to this container's contents
	 */
	virtual void addLeafUInt16(const std::string& leafName, uint16_t leafValue) override ;

	/**
	 * Add a leaf value to this container's contents
	 */
	virtual void addLeafUInt8(const std::string& leafName, uint8_t leafValue) override ;

	/**
	 * Add a leaf value to this container's contents
	 */
	virtual void addLeafInt64(const std::string& leafName, int64_t leafValue) override ;

	/**
	 * Add a leaf value to this container's contents
	 */
	virtual void addLeafInt32(const std::string& leafName, int32_t leafValue) override ;

	/**
	 * Add a leaf value to this container's contents
	 */
	virtual void addLeafInt16(const std::string& leafName, int16_t leafValue) override ;

	/**
	 * Add a leaf value to this container's contents
	 */
	virtual void addLeafInt8(const std::string& leafName, int8_t leafValue) override ;
