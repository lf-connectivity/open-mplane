...
public:
	...
	/**
	 * Given a set of YangParams, pulls out the common parameters used in multiple rpcs that specify the authentication
	 * arguments for authenticating the user and server
	 *
	 */
	static bool authParams(std::shared_ptr<YangParams> callList,
