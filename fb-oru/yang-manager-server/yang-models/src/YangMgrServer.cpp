...
// ------------------------------------------------------------------------------------------------------------
std::shared_ptr<IYangModule> YangMgrServer::getModule(Module_E id)
{
	return YangModuleMgr::getModule((uint32_t)id);
}

// ------------------------------------------------------------------------------------------------------------
std::shared_ptr<IYangModule> YangMgrServer::getModule(uint32_t id)
{
	return YangModuleMgr::getModule(id);
}

// ------------------------------------------------------------------------------------------------------------
uint32_t YangMgrServer::getNumModules(void) const
{
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createDatastore(void)
{
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createModules(void)
{
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIanaHardware(Module_E id)
{
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIanaIfType(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfCryptoTypes(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfDhcpv6Types(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfHardware(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfInetTypes(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfInterfaces(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfIp(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfNetconfAcm(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfNetconfMonitoring(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleIetfNetconfMonitoring_NS::ModuleIetfNetconfMonitoring::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfYangLibrary(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createIetfYangTypes(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanAldPort(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanAld(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanAntennaCalibration(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleORanAntennaCalibration_NS::ModuleORanAntennaCalibration::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanCompressionFactors(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleORanCompressionFactors_NS::ModuleORanCompressionFactors::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanDelayManagement(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleORanDelayManagement_NS::ModuleORanDelayManagement::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanDhcp(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanEcpriDelay(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanExternalio(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanFan(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanFileManagement(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleORanFileManagement_NS::ModuleORanFileManagement::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanFm(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanHardware(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanInterfaces(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanLaaOperations(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleORanLaaOperations_NS::ModuleORanLaaOperations::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanLaa(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanLbm(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanModuleCap(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanMplaneInt(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanOperations(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanPerformanceManagement(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleORanPerformanceManagement_NS::ModuleORanPerformanceManagement::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanProcessingElement(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleORanProcessingElement_NS::ModuleORanProcessingElement::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanSoftwareManagement(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleORanSoftwareManagement_NS::ModuleORanSoftwareManagement::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanSupervision(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanSync(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanTrace(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanTransceiver(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanTroubleshooting(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;

	// Create module
	std::shared_ptr<YangModule> module(
		ModuleORanTroubleshooting_NS::ModuleORanTroubleshooting::createModule(moduleId)
	);
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanUdpEcho(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanUplaneConf(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
...
// ------------------------------------------------------------------------------------------------------------
YangResult_E YangMgrServer::createORanUsermgmt(Module_E id)
{
	uint32_t moduleId = (uint32_t)id;
