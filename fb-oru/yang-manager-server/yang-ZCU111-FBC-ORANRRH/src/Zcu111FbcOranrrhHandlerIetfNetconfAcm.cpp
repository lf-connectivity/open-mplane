 ...
 *
 * \file      Zcu111FbcOranrrhHandlerIetfNetconfAcm.cpp
...
//-------------------------------------------------------------------------------------------------------------
Zcu111FbcOranrrhHandlerIetfNetconfAcm::Zcu111FbcOranrrhHandlerIetfNetconfAcm(std::shared_ptr<IYangModuleMgr> moduleMgr)
	: YangHandlerSysrepo("ietf-netconf-acm", moduleMgr, "Zcu111FbcOranrrhHandlerIetfNetconfAcm")
	, mCallback(std::make_shared<SysrepoGetitemsCallback>(path("nacm")))
{
}

//-------------------------------------------------------------------------------------------------------------
Zcu111FbcOranrrhHandlerIetfNetconfAcm::~Zcu111FbcOranrrhHandlerIetfNetconfAcm()
{
}

//-------------------------------------------------------------------------------------------------------------
bool Zcu111FbcOranrrhHandlerIetfNetconfAcm::initialise()
{
	// ------------------------------------------------------------------------
	...
	// NOTE: We set up the groups/users in a start up script (so that o-ran-usermgmt can be initialised)
	// That means we only need to add in the access rules here (done here to minimise the start up script)
...
//-------------------------------------------------------------------------------------------------------------
void Zcu111FbcOranrrhHandlerIetfNetconfAcm::valueChange(const std::string & xpath,
                                                        std::shared_ptr<YangParam> oldValue,
                                                        std::shared_ptr<YangParam> newValue)
{
	logDebugVerbose("Zcu111FbcOranrrhHandlerIetfNetconfAcm::valueChange() - %s", xpath.c_str());
}


//-------------------------------------------------------------------------------------------------------------
int Zcu111FbcOranrrhHandlerIetfNetconfAcm::validate(std::shared_ptr<YangParams> params,
