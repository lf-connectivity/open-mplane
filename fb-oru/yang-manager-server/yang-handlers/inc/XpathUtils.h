...
public:
	 ...
	 */
	static bool listIndex(const std::string& xpath, std::string& listName, std::string& key, std::string& value) ;

	/**
	 * Get the *first* index (i.e. in "[]") contained in the xpath. Value string is converted into an integer
	 */
	static bool listIndex(const std::string& xpath, std::string& listName, std::string& key, int& value) ;
