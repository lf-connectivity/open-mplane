...
//-------------------------------------------------------------------------------------------------------------
std::string XpathUtils::leafName(const std::string &xpath)
{
...
//-------------------------------------------------------------------------------------------------------------
std::string XpathUtils::leafPath(const std::string &xpath)
{
...
//-------------------------------------------------------------------------------------------------------------
bool XpathUtils::listIndex(const std::string &xpath, std::string& listName, std::string &key, std::string &value)
{
	listName.clear() ;
	key.clear() ;
	value.clear() ;
...
//-------------------------------------------------------------------------------------------------------------
bool XpathUtils::listIndex(const std::string &xpath, std::string& listName, std::string &key, int &value)
{
	std::string valstr ;
