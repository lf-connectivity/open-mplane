 ...
 *
 * \file      OranAlarms_unittest.cpp
 * \brief     Google Test of ORAN Alarms
 *
 *
 * \details   This file contains the implementation of the Google Test test cases
 *            for the ORAN Alarms class.
 *
 */
...
TEST(CUPlaneConnectivityAlarms, Test)
{
	TestDef testData
	{
		...
		//	{ faultName,           fault,                                       alarm                                        },
			{ "ConnectivityMinorFault", make_fault<CUPlaneConnectivityMinorFault>(), make_alarm<CUPlaneConnectivityMinorAlarm>() },
			{ "ConnectivityMajorFault", make_fault<CUPlaneConnectivityMajorFault>(), make_alarm<CUPlaneConnectivityMajorAlarm>() },
		},
	};
	testData.runTests();
}
