...
public:
     ...
     *
     * The run method should implement to provide normal application control operation.
     *
...
/**
 * The IappControlFactory class defines a factory interface used to create an instance
 * of an Mplane::IAppControl implementation. The actual implementation is defined by the
 * application build at final link.
 */
