 ...
 *
 * \file      AlarmCUPlaneConnectivityMinor.h
...
class AlarmCUPlaneConnectivityMinor : public Alarm
{
public:
	AlarmCUPlaneConnectivityMinor() ;

	virtual ~AlarmCUPlaneConnectivityMinor() ;
