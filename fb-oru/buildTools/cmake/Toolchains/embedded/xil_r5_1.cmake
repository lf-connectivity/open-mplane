##======================================================================================================================
## Settings for ARM R5-1 builds
##
## Useage: cmake -DCMAKE_TOOLCHAIN_FILE=~/git/buildTools/cmake/Toolchains/embedded/xil_r5_1.cmake <src>
##
...
message ("xil_r5_1.cmake: GITDIR=${GITDIR} PROJECT_SOURCE_DIR=${PROJECT_SOURCE_DIR}") 
